...
Warning: do not edit this file on a feature branch. Every branch then changes the
same lines, and each rebase reports a conflict. Add one unique fragment under
[`changelog.d/`](changelog.d/README.md) instead. The release coordinator collects
the merged fragments into this file at release time.
