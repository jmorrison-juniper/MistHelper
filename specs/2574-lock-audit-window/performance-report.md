...
Measured: For 1,000 rows, wall median changed from 18.8147 ms to 13.2574 ms, or -29.54 percent. CPU median was unchanged at 15.6250 ms. For 10,000 rows, wall median changed from 794.8058 ms to 872.7037 ms, or +9.80 percent. The wall MAD was high, and CPU median changed from 234.3750 ms to 125.0000 ms, or -46.67 percent. For 50,000 rows, wall median changed from 6,232.5923 ms to 3,672.1778 ms, or -41.08 percent. CPU median changed from 1,187.5000 ms to 781.2500 ms, or -34.21 percent.
...
Measured: `test_the_capped_read_matches_the_full_expiry_inference` proves that the capped read equals a full read plus full expiry inference for the returned page. Added tests also cover one row, a trail shorter than the window, and row field types. Existing tests cover an empty trail and a malformed line. Targeted history tests passed.
