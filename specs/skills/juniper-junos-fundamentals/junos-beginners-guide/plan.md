...
**Storage**: Markdown artifacts under `specs/skills/juniper-junos-fundamentals/junos-beginners-guide`
...
```text
specs/skills/juniper-junos-fundamentals/junos-beginners-guide/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
