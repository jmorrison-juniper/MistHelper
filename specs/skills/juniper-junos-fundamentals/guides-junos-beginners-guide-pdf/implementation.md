# Implementation Record: Day One: Beginner's Guide to Learning Junos skill package
...
- Joined 1 source part files.
- Built 47 topic files.
- Ran the guard with result `not measured`.
