...
- [X] T037 Run manual test scenarios from specs/006-web-interactivity/quickstart.md — interactive operation (Menu 31), modal preview (CSV), operation results preview
