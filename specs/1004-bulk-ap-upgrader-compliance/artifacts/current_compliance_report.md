...
- **Generated**: 2026-07-02 05:10:59 UTC
...
| Line | Severity | Rule | Symbol | Issue | Remediation |
| - | - | - | - | - | - |
| 27 | high | CONV-COMMENTS | <file> | Inline-comment coverage is 33.3%; uncommented lines: 27, 79, 94, 114, 128, 146, 157, 159, 161, 166, 180, 201. | Add a same-line comment explaining intent on each executable line of changed code. |
...
- [ ] **CMP-001** `src\firmware\bulk_ap_upgrader.py:27` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
  - Problem: Inline-comment coverage is 33.3%; uncommented lines: 27, 79, 94, 114, 128, 146, 157, 159, 161, 166, 180, 201.
