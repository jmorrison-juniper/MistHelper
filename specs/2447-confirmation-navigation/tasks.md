...
- [ ] T004 Add Playwright coverage for visible run-page navigation in `tests/e2e/upgrade_portal/test_capture.py`
...
- [ ] T008 Update GitHub issue #2447 with SpecKit links, test results, and remaining findings
- [ ] T009 Commit, push, open/update PR, and monitor checks
