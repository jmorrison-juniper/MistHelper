...
class FirmwareManager:
    ...
    def _validate_org_for_ssr_upgrade(self) -> tuple[str, dict[str, Any] | None]:
        ...
        try:
            ...
            logging.error("Organization validation failed: %s", str(e))  # WHY: structured audit
    ...
    def _select_ssr_sites_for_upgrade(
        ...
        try:
            ...
            logging.error("Site discovery failed: %s", str(e))  # WHY: structured audit
    ...
    def _fetch_and_select_ssr_version(self, firmware_channel: str) -> tuple[str, dict[str, Any] | None]:
        ...
        try:
            ...
            logging.error("SSR firmware discovery failed: %s", str(e))
    ...
    def _run_ssr_site_upgrades(
        ...
        try:
            ...
            logging.error("Critical error in SSR firmware upgrade: %s", str(e))  # WHY: audit failure
    ...
    def _export_device_status(self, timestamp: str) -> None:
        ...
        try:  # WHY: tolerate write errors
            ...
            _MH.DataExporter.write_with_format_selection(
                self.upgrade_results, filename, api_function_name="listSiteDeviceUpgrades"
            )
