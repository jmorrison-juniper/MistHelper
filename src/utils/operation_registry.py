...
class OperationRegistry:
    ...
    _REGISTRY: dict[str, _OptionEntry] = {
        ...
        "210": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "211": {"category": "interactive_safe", "skip_reason": "Requires site and asset filter selection"},
        "212": {"category": "interactive_safe", "skip_reason": "Requires site and asset selection"},
        "213": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "214": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "215": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "216": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "217": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "218": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "219": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "220": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "221": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "222": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "223": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "224": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "225": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "226": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "227": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "228": {"category": "interactive_safe", "skip_reason": "Requires site selection"},
        "229": {"category": "interactive_safe", "skip_reason": "Requires site and zone type selection"},
        "230": {"category": "safe"},
        "231": {"category": "safe"},
        "232": {"category": "safe"},
        "233": {"category": "safe"},
        ...
        "249": {"category": "safe"},
        # WHY: menu 250 reads organization variables and writes only local export data.
        "250": {
            "category": "safe",
        },
        ...
        # WHY: menu 258 reads other-device events for a selected site and writes only local
        # export data. The site prompt makes this interactive_safe, not safe.
        "258": {
            "category": "interactive_safe",
