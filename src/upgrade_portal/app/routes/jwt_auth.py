...
from flask import Blueprint, request, jsonify  # WHY: Flask framework
    ...
    def login():
        ...
        try:
            ...
            return jsonify({  # WHY: success response
                ...
                'warning_threshold_seconds': session_manager.WARNING_THRESHOLD_SECONDS,  # WHY: warning threshold
            }), 200  # WHY: HTTP 200 OK
