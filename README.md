...
The tool holds **257 operations**, numbered 1 to 261 with gaps at 152, 252, and
259-260. Menu 0 is Exit. Read
[the menu reference](documentation/menu_reference.md) for the full list, which
...
selected site through `searchSiteOtherDeviceEvents`. Menu 261 searches
organization other-device events through `searchOrgOtherDeviceEvents`.
