...
**Operation Count:** The code currently defines 133 actionable menu entries (1–10, 11–89, 90–106, 107–111, 112, 195–215) with some gaps for future expansion. Operations 195–215 cover upstream mistapi v0.60–v0.63 endpoints (RF channel scores, IoT endpoints, NAC CoA, auto-map assignment, Zigbee join, SSO admin delete, MxEdge upgrade, org async-claim workflows, and org Marvis client insights/events/stats workflows).
