"""Mist Ideas Analyzer package — AI-powered classification of Mist community ideas.
...
(Markdown, JSON, CSV). The AI classifies each idea by MistHelper feasibility
using 7 labels plus ``AI_INSPIRED``, identifies duplicates, groups into
themes, and discovers snowball dependency chains.
...
__all__ = ["main"]  # WHY: constrain the package surface to the CLI entry point
