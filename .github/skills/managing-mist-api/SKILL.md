...
- The installed `mistapi` package is version `0.64.0`. It is the source for SDK module names, function names, and call signatures.
- [The primary OpenAPI 3.1 JSON](../../../documentation/mist-api-openapi31json.json) is version `2607.1.1` and defines 1,059 operations across 756 paths.
- [The endpoint index](../../../documentation/api/INDEX.md) links those operations and 23 library-only SDK stubs.
...
The verified snapshot date is 2026-09-16. These counts describe local documents, not the current cloud service.
Read the source-authority guide when SDK call signatures, paths, fields, or examples disagree.
