...
- Python 3.13.3, the interpreter this repository already uses. + The standard library only. `json`, `pathlib`, `dataclasses`, `logging`, (2159-openapi-mib-generator)
- Two checked-in JSON files under `data/mib_generator/`. One output text file under (2159-openapi-mib-generator)
...
## Recent Changes
- 2159-openapi-mib-generator: Added Python 3.13.3, the interpreter this repository already uses. + The standard library only. `json`, `pathlib`, `dataclasses`, `logging`,
