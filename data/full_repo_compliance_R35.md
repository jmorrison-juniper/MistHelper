...
- **Generated**: 2026-07-05 03:59:21 UTC
...
| - | - |
| Lines of code | 332 |
| Executable code lines | 216 |
| Functions | 18 |
| Classes | 1 |
| Average complexity | 4.4 |
| Max complexity | 11 |
| Inline comment coverage | 51.9% |
...
| Line | Severity | Rule | Symbol | Issue | Remediation |
| - | - | - | - | - | - |
| 287 | high | STRUCT-COMPLEXITY | _execute_pipeline | Cyclomatic complexity is 11 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |
| 138 | low | STRUCT-COMPLEXITY | _resolve_password | Cyclomatic complexity is 7 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |
| 165 | low | STRUCT-COMPLEXITY | _check_required_params | Cyclomatic complexity is 6 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |
| 213 | low | STRUCT-COMPLEXITY | _validate_commands | Cyclomatic complexity is 6 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |

#### Conventions

| Line | Severity | Rule | Symbol | Issue | Remediation |
| - | - | - | - | - | - |
| 8 | medium | CONV-COMMENTS | <file> | Inline-comment coverage is 51.9%; uncommented lines: 8, 35, 40, 43, 48, 52, 57, 60, 62, 63, 66, 69. | Add a same-line comment explaining intent on each executable line of changed code. |

#### Structure

| Line | Severity | Rule | Symbol | Issue | Remediation |
| - | - | - | - | - | - |
| 231 | high | STRUCT-PARAMS | _dispatch_execution | Function takes 6 parameters (limit 5). | Group related parameters into a dataclass/config object or split the function. |
| 262 | high | STRUCT-PARAMS | _dispatch_multi_host | Function takes 6 parameters (limit 5). | Group related parameters into a dataclass/config object or split the function. |
| 66 | medium | STRUCT-LENGTH | _install_line_tracer | Function spans 27 lines (limit 25). | Extract logical sections into well-named helper methods to shrink the function. |
| 231 | medium | STRUCT-LENGTH | _dispatch_execution | Function spans 29 lines (limit 25). | Extract logical sections into well-named helper methods to shrink the function. |
| 287 | medium | STRUCT-LENGTH | _execute_pipeline | Function spans 27 lines (limit 25). | Extract logical sections into well-named helper methods to shrink the function. |
| 287 | low | STRUCT-BLOCKS | _execute_pipeline | Function has 6 logical blocks (limit 5). | Split the function so each helper owns a single cohesive block of logic. |
...
| Line | Severity | Rule | Symbol | Issue | Remediation |
| - | - | - | - | - | - |
| 64 | low | STRUCT-COMPLEXITY | _run_interactive_workflow | Cyclomatic complexity is 7 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |
| 97 | low | STRUCT-COMPLEXITY | by_gateway_template | Cyclomatic complexity is 6 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |
| 131 | low | STRUCT-COMPLEXITY | _collect_missing_data | Cyclomatic complexity is 8 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |
| 209 | low | STRUCT-COMPLEXITY | _execute_ssh | Cyclomatic complexity is 6 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |
| 313 | low | STRUCT-COMPLEXITY | _print_template_menu | Cyclomatic complexity is 7 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |
| 350 | low | STRUCT-COMPLEXITY | _filter_gateways | Cyclomatic complexity is 6 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |
| 396 | low | STRUCT-COMPLEXITY | _execute_by_template | Cyclomatic complexity is 6 (target <= 5). | Reduce branching by extracting helpers, using guard clauses, or simplifying logic. |

#### Conventions

| Line | Severity | Rule | Symbol | Issue | Remediation |
| - | - | - | - | - | - |
| 3 | high | CONV-COMMENTS | <file> | Inline-comment coverage is 27.5%; uncommented lines: 3, 5, 6, 7, 8, 9, 10, 23, 26, 27, 28, 29. | Add a same-line comment explaining intent on each executable line of changed code. |

#### Structure

| Line | Severity | Rule | Symbol | Issue | Remediation |
| - | - | - | - | - | - |
| 97 | medium | STRUCT-LENGTH | by_gateway_template | Function spans 32 lines (limit 25). | Extract logical sections into well-named helper methods to shrink the function. |
| 131 | medium | STRUCT-LENGTH | _collect_missing_data | Function spans 31 lines (limit 25). | Extract logical sections into well-named helper methods to shrink the function. |
| 209 | medium | STRUCT-LENGTH | _execute_ssh | Function spans 56 lines (limit 25). | Extract logical sections into well-named helper methods to shrink the function. |
| 396 | medium | STRUCT-LENGTH | _execute_by_template | Function spans 50 lines (limit 25). | Extract logical sections into well-named helper methods to shrink the function. |
...
> Note: showing the 300 highest-severity of 399 tasks.

### Phase: High (91 task(s))
...
- [ ] **CMP-010** `src\capture\org_capture_workflow.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-011** `src\capture\packet_capture_download.py:235` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-012** `src\capture\site_capture_loop.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-013** `src\db\__init__.py:8` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-014** `src\db\retention.py:8` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-015** `src\db\router.py:7` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-016** `src\export\device_events_52w_exporter.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-017** `src\export\device_events_52w_exporter.py:192` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-018** `src\export\site_insights\device_metric_operation.py:170` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-019** `src\export\site_insights_exporter.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-020** `src\export\site_insights_exporter.py:17` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-021** `src\gateway\device_template_cloner.py:91` - STRUCT-PARAMS (Structure)
  - Symbol: `__init__`
  - Problem: Function takes 6 parameters (limit 5).
  - Fix: Group related parameters into a dataclass/config object or split the function.
  - Done when: analyzer reports no STRUCT-PARAMS for `__init__` in `src\gateway\device_template_cloner.py`.
- [ ] **CMP-022** `src\gateway\gateway_export_utils.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-023** `src\gateway\gateway_export_utils.py:39` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-024** `src\gateway\gateway_export_utils.py:39` - STRUCT-LENGTH (Structure)
  - Symbol: `configure_gateway_export_utils_dependencies`
...
- [ ] **CMP-025** `src\gateway\gateway_export_utils.py:235` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-026** `src\gateway\gateway_stats_exporter.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-027** `src\gateway\gateway_stats_exporter.py:29` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-028** `src\gateway\overrides\_deps.py:19` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-029** `src\inventory\org_device_inventory_summary.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-030** `src\maps\_flask_viewer.py:12` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-031** `src\maps\_flask_viewer.py:24` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-032** `src\maps\_flask_viewer.py:47` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-033** `src\maps\_flask_viewer.py:176` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-034** `src\maps\_flask_viewer.py:176` - STRUCT-LENGTH (Structure)
  - Symbol: `launch_flask_viewer`
...
- [ ] **CMP-035** `src\maps\_maps_backup.py:15` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-036** `src\maps\_maps_backup.py:170` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-037** `src\maps\_maps_backup.py:262` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-038** `src\maps\_maps_backup.py:262` - ARCH-DELEGATE (Architecture)
  - Symbol: `backup_map_geometry`
...
- [ ] **CMP-039** `src\maps\_maps_clone.py:14` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-040** `src\maps\_maps_matplotlib.py:16` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-041** `src\maps\_maps_matplotlib.py:136` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-042** `src\maps\_maps_utils.py:10` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-043** `src\maps\plotly_heatmap_renderer.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-044** `src\maps\plotly_heatmap_renderer.py:18` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-045** `src\maps\plotly_heatmap_renderer.py:110` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-046** `src\maps\plotly_heatmap_renderer.py:144` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-047** `src\maps\plotly_map_callback_manager.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-048** `src\maps\plotly_map_callback_manager.py:42` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-049** `src\maps\plotly_map_figure_builder.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-050** `src\maps\plotly_map_figure_builder.py:94` - STRUCT-LENGTH (Structure)
  - Symbol: `add_zones`
...
- [ ] **CMP-051** `src\maps\plotly_map_serializer.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-052** `src\maps\plotly_map_serializer.py:10` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-053** `src\maps\plotly_map_templates.py:4` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-054** `src\maps\plotly_map_templates.py:22` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-055** `src\marvis\marvis_utils.py:58` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-056** `src\org_data_collector.py:9` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-057** `src\refactors\serial_cc\security_events.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-058** `src\refactors\serial_cc\security_events.py:105` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-059** `src\refactors\serial_cc\site_client_insights.py:135` - STRUCT-LENGTH (Structure)
  - Symbol: `execute`
...
- [ ] **CMP-060** `src\refactors\serial_cc\start_site_client_capture_wireless.py:186` - STRUCT-LENGTH (Structure)
  - Symbol: `execute`
  - Problem: Function spans 64 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `execute` in `src\refactors\serial_cc\start_site_client_capture_wireless.py`.
- [ ] **CMP-061** `src\refactors\serial_cc\start_site_scan_capture.py:232` - STRUCT-LENGTH (Structure)
  - Symbol: `execute`
...
- [ ] **CMP-062** `src\ssh\runtime\app_runner.py:231` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-063** `src\ssh\runtime\app_runner.py:262` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-064** `src\ssh\runtime\app_runner.py:287` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-065** `src\ssh\ssh_runner_manager.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
  - Problem: Inline-comment coverage is 27.5%; uncommented lines: 3, 5, 6, 7, 8, 9, 10, 23, 26, 27, 28, 29.
  - Fix: Add a same-line comment explaining intent on each executable line of changed code.
  - Done when: analyzer reports no CONV-COMMENTS for `<file>` in `src\ssh\ssh_runner_manager.py`.
- [ ] **CMP-066** `src\ssid_consolidation\_ssid_template_phase2.py:37` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-067** `src\ssid_consolidation\_ssid_template_phase3.py:39` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-068** `src\ssid_consolidation\_ssid_template_phase45.py:81` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-069** `src\troubleshooting\interactive_test_runner.py:29` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-070** `src\troubleshooting\interactive_test_runner.py:256` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-071** `src\troubleshooting\interactive_test_runner.py:278` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-072** `src\troubleshooting\marvis_troubleshoot_utils.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-073** `src\ui\execution\__init__.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-074** `src\ui\execution\item_executor.py:7` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-075** `src\ui\execution\output_formatter.py:7` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-076** `src\ui\input_handlers\__init__.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-077** `src\ui\layout\__init__.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
  - Problem: Inline-comment coverage is 0.0%; uncommented lines: 3, 4.
  - Fix: Add a same-line comment explaining intent on each executable line of changed code.
  - Done when: analyzer reports no CONV-COMMENTS for `<file>` in `src\ui\layout\__init__.py`.
- [ ] **CMP-078** `src\ui\layout\results_grid_builder.py:7` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-079** `src\ui\runtime\__init__.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-080** `src\ui\runtime\level_discoverer.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-081** `src\utils\rate_limiting.py:6` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-082** `src\utils\rate_limiting.py:240` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-083** `src\utils\rate_limiting.py:332` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-084** `src\wan_hub_group_manager.py:13` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-085** `src\websocket\__init__.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-086** `src\websocket\diagnostics\ping_executor.py:116` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-087** `src\websocket\diagnostics\ping_executor.py:145` - STRUCT-PARAMS (Structure)
...
- [ ] **CMP-088** `src\websocket\polling\message_router.py:7` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-089** `src\websocket\polling\result_collector.py:8` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-090** `src\websocket\polling\result_combiner.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-091** `src\websocket\polling\result_combiner.py:12` - STRUCT-PARAMS (Structure)
...
### Phase: Medium (144 task(s))

- [ ] **CMP-092** `src\analytics\site_inventory_health_analyzer.py:26` - STRUCT-LENGTH (Structure)
  - Symbol: `analyze`
...
- [ ] **CMP-093** `src\analytics\site_inventory_health_analyzer.py:146` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-094** `src\analytics\site_inventory_health_analyzer.py:199` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-095** `src\analytics\site_inventory_health_analyzer.py:283` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-098** `src\audit\analyzer.py:150` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-099** `src\audit\analyzer.py:183` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-103** `src\capture\org_capture_workflow.py:15` - STRUCT-LENGTH (Structure)
  - Symbol: `run`
...
- [ ] **CMP-104** `src\capture\org_pcap_wait_download_workflow.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-105** `src\capture\org_pcap_wait_download_workflow.py:20` - STRUCT-LENGTH (Structure)
  - Symbol: `execute`
...
- [ ] **CMP-106** `src\capture\packet_capture_download.py:18` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-107** `src\capture\packet_capture_download.py:63` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-108** `src\capture\packet_capture_download.py:122` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-109** `src\capture\packet_capture_download.py:174` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-110** `src\capture\packet_capture_download.py:355` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-120** `src\export\site_insights\device_metric_operation.py:14` - STRUCT-LENGTH (Structure)
  - Symbol: `execute`
  - Problem: Function spans 54 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `execute` in `src\export\site_insights\device_metric_operation.py`.
- [ ] **CMP-121** `src\export\site_insights\device_metric_operation.py:170` - STRUCT-LENGTH (Structure)
  - Symbol: `_collect_metrics`
  - Problem: Function spans 28 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `_collect_metrics` in `src\export\site_insights\device_metric_operation.py`.
- [ ] **CMP-122** `src\export\site_insights\device_metric_operation.py:200` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-123** `src\export\site_insights\device_metric_operation.py:229` - STRUCT-LENGTH (Structure)
  - Symbol: `_finalize`
  - Problem: Function spans 44 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `_finalize` in `src\export\site_insights\device_metric_operation.py`.
- [ ] **CMP-124** `src\export\site_insights\site_metric_operation.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-125** `src\export\site_insights\site_metric_operation.py:16` - STRUCT-LENGTH (Structure)
  - Symbol: `execute`
...
- [ ] **CMP-126** `src\export\site_insights\site_metric_operation.py:132` - STRUCT-LENGTH (Structure)
  - Symbol: `_finalize`
...
- [ ] **CMP-127** `src\export\site_insights_exporter.py:17` - STRUCT-LENGTH (Structure)
  - Symbol: `configure_site_insights_exporter_dependencies`
...
- [ ] **CMP-128** `src\export\wifi_clients_exporter.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-129** `src\export\wifi_clients_exporter.py:24` - STRUCT-LENGTH (Structure)
  - Symbol: `execute`
  - Problem: Function spans 32 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `execute` in `src\export\wifi_clients_exporter.py`.
- [ ] **CMP-130** `src\export\wifi_clients_exporter.py:132` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-131** `src\export\wifi_clients_exporter.py:228` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-132** `src\gateway\device_template_cloner.py:276` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-133** `src\gateway\device_template_cloner.py:398` - STRUCT-LENGTH (Structure)
  - Symbol: `clone`
...
- [ ] **CMP-134** `src\gateway\gateway_export_utils.py:184` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-135** `src\gateway\gateway_export_utils.py:390` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-136** `src\gateway\gateway_stats_exporter.py:29` - STRUCT-LENGTH (Structure)
  - Symbol: `configure_gateway_stats_exporter_dependencies`
...
- [ ] **CMP-137** `src\gateway\gateway_stats_exporter.py:87` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-138** `src\gateway\gateway_stats_exporter.py:147` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-139** `src\gateway\overrides\_deps.py:19` - STRUCT-LENGTH (Structure)
  - Symbol: `configure_gateway_override_dependencies`
  - Problem: Function spans 33 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
...
- [ ] **CMP-140** `src\inventory\org_device_inventory_summary.py:43` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-141** `src\inventory\org_device_inventory_summary.py:254` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-142** `src\inventory\org_device_inventory_summary.py:352` - STRUCT-LENGTH (Structure)
  - Symbol: `run_for_org`
  - Problem: Function spans 51 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `run_for_org` in `src\inventory\org_device_inventory_summary.py`.
- [ ] **CMP-143** `src\maps\_maps_backup.py:37` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-144** `src\maps\_maps_backup.py:89` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-145** `src\maps\_maps_clone.py:127` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-146** `src\maps\_maps_clone.py:267` - STRUCT-LENGTH (Structure)
  - Symbol: `clone_map`
...
- [ ] **CMP-147** `src\maps\_maps_matplotlib.py:38` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-148** `src\maps\_maps_utils.py:81` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-153** `src\maps\plotly_map_figure_builder.py:178` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-154** `src\maps\plotly_map_templates.py:149` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-155** `src\marvis\marvis_utils.py:156` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-156** `src\marvis\marvis_utils.py:200` - STRUCT-LENGTH (Structure)
  - Symbol: `_build_flat_row`
  - Problem: Function spans 36 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `_build_flat_row` in `src\marvis\marvis_utils.py`.
- [ ] **CMP-157** `src\marvis\marvis_utils.py:237` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-158** `src\marvis\marvis_utils.py:265` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-167** `src\refactors\serial_cc\security_events.py:189` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-168** `src\refactors\serial_cc\site_client_insights.py:81` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-169** `src\refactors\serial_cc\start_site_client_capture_wireless.py:89` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-170** `src\refactors\serial_cc\start_site_scan_capture.py:202` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-171** `src\refactors\serial_cc\switch_vc_stats.py:49` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-172** `src\refactors\serial_cc\switch_vc_stats.py:91` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-173** `src\refactors\serial_cc\switch_vc_stats.py:91` - STRUCT-NESTING (Structure)
  - Symbol: `_collect_vc_stats`
...
- [ ] **CMP-174** `src\refactors\serial_cc\switch_vc_stats.py:124` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-175** `src\site\address_audit\address_corrector.py:30` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-176** `src\site\address_audit\address_resolver.py:88` - STRUCT-LENGTH (Structure)
  - Symbol: `_combine`
  - Problem: Function spans 28 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `_combine` in `src\site\address_audit\address_resolver.py`.
- [ ] **CMP-177** `src\site\address_audit\address_resolver.py:161` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-178** `src\site\address_audit\address_resolver.py:426` - STRUCT-LENGTH (Structure)
  - Symbol: `_from_cache`
  - Problem: Function spans 26 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `_from_cache` in `src\site\address_audit\address_resolver.py`.
- [ ] **CMP-179** `src\site\address_audit\business_authority_ingester.py:73` - STRUCT-LENGTH (Structure)
  - Symbol: `match`
...
- [ ] **CMP-180** `src\site\address_audit\ui_geocoder.py:306` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-181** `src\site\address_audit\ui_geocoder.py:446` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-182** `src\site\address_audit\ui_geocoder.py:541` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-183** `src\ssh\connection\connector.py:9` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-184** `src\ssh\connection\connector.py:48` - STRUCT-LENGTH (Structure)
  - Symbol: `connect`
  - Problem: Function spans 28 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `connect` in `src\ssh\connection\connector.py`.
- [ ] **CMP-185** `src\ssh\connection\connector.py:228` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-186** `src\ssh\connection\connector.py:257` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-187** `src\ssh\runtime\app_runner.py:8` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
  - Problem: Inline-comment coverage is 51.9%; uncommented lines: 8, 35, 40, 43, 48, 52, 57, 60, 62, 63, 66, 69.
  - Fix: Add a same-line comment explaining intent on each executable line of changed code.
  - Done when: analyzer reports no CONV-COMMENTS for `<file>` in `src\ssh\runtime\app_runner.py`.
- [ ] **CMP-188** `src\ssh\runtime\app_runner.py:66` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-193** `src\ssh\shell_execution\shell_executor.py:189` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-194** `src\ssh\shell_execution\shell_executor.py:236` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-195** `src\ssh\ssh_runner_manager.py:97` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-196** `src\ssh\ssh_runner_manager.py:131` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-197** `src\ssh\ssh_runner_manager.py:209` - STRUCT-LENGTH (Structure)
  - Symbol: `_execute_ssh`
...
- [ ] **CMP-198** `src\ssh\ssh_runner_manager.py:396` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-199** `src\ssid_consolidation\_ssid_template_phase2.py:95` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-200** `src\ssid_consolidation\_ssid_template_phase2.py:177` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-201** `src\ssid_consolidation\_ssid_template_phase3.py:191` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-202** `src\ssid_consolidation\_ssid_template_phase3.py:245` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-203** `src\ssid_consolidation\_ssid_template_phase45.py:140` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-204** `src\ssid_consolidation\_ssid_template_phase45.py:435` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-205** `src\troubleshooting\interactive_test_runner.py:3` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-206** `src\troubleshooting\interactive_test_runner.py:208` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-207** `src\troubleshooting\interactive_test_runner.py:278` - STRUCT-LENGTH (Structure)
  - Symbol: `_print_summary`
  - Problem: Function spans 34 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `_print_summary` in `src\troubleshooting\interactive_test_runner.py`.
- [ ] **CMP-208** `src\troubleshooting\marvis_troubleshoot_utils.py:52` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-209** `src\troubleshooting\marvis_troubleshoot_utils.py:80` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-210** `src\troubleshooting\marvis_troubleshoot_utils.py:121` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-211** `src\troubleshooting\marvis_troubleshoot_utils.py:203` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-212** `src\troubleshooting\marvis_troubleshoot_utils.py:410` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-213** `src\troubleshooting\marvis_troubleshoot_utils.py:441` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-214** `src\ui\execution\item_executor.py:28` - STRUCT-LENGTH (Structure)
  - Symbol: `execute`
  - Problem: Function spans 30 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `execute` in `src\ui\execution\item_executor.py`.
- [ ] **CMP-215** `src\ui\input_handlers\key_poller.py:7` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-216** `src\ui\layout\layout_builder.py:7` - CONV-COMMENTS (Conventions)
  - Symbol: `<file>`
...
- [ ] **CMP-217** `src\ui\layout\layout_builder.py:25` - STRUCT-LENGTH (Structure)
  - Symbol: `build`
  - Problem: Function spans 27 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `build` in `src\ui\layout\layout_builder.py`.
- [ ] **CMP-218** `src\utils\rate_limiting.py:170` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-223** `src\websocket\commands.py:33` - STRUCT-LENGTH (Structure)
  - Symbol: `execute`
  - Problem: Function spans 41 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `execute` in `src\websocket\commands.py`.
- [ ] **CMP-224** `src\websocket\commands.py:114` - STRUCT-LENGTH (Structure)
  - Symbol: `_trigger_rpc`
...
- [ ] **CMP-225** `src\websocket\diagnostics\arp_executor.py:67` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-226** `src\websocket\diagnostics\arp_executor.py:150` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-227** `src\websocket\diagnostics\arp_executor.py:178` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-228** `src\websocket\diagnostics\arp_executor.py:207` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-229** `src\websocket\diagnostics\arp_executor.py:252` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-230** `src\websocket\diagnostics\arp_executor.py:338` - STRUCT-LENGTH (Structure)
...
- [ ] **CMP-231** `src\websocket\diagnostics\ping_executor.py:116` - STRUCT-LENGTH (Structure)
  - Symbol: `_issue_ping_and_render`
  - Problem: Function spans 28 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `_issue_ping_and_render` in `src\websocket\diagnostics\ping_executor.py`.
- [ ] **CMP-232** `src\websocket\diagnostics\ping_executor.py:145` - STRUCT-LENGTH (Structure)
  - Symbol: `_post_ping_command`
...
- [ ] **CMP-233** `src\websocket\diagnostics\ping_executor.py:181` - STRUCT-LENGTH (Structure)
  - Symbol: `_await_and_render`
  - Problem: Function spans 28 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `_await_and_render` in `src\websocket\diagnostics\ping_executor.py`.
- [ ] **CMP-234** `src\websocket\polling\result_collector.py:75` - STRUCT-LENGTH (Structure)
  - Symbol: `collect`
  - Problem: Function spans 30 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
  - Done when: analyzer reports no STRUCT-LENGTH for `collect` in `src\websocket\polling\result_collector.py`.
- [ ] **CMP-235** `src\websocket\polling\result_combiner.py:12` - STRUCT-LENGTH (Structure)
  - Symbol: `combine_segments`
  - Problem: Function spans 34 lines (limit 25).
  - Fix: Extract logical sections into well-named helper methods to shrink the function.
...
- [ ] **CMP-236** `src\analytics\site_inventory_health_analyzer.py:146` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_find_sites_missing_infrastructure`
...
- [ ] **CMP-237** `src\analytics\site_inventory_health_analyzer.py:199` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_build_offline_entry`
...
- [ ] **CMP-238** `src\analytics\site_inventory_health_analyzer.py:251` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-239** `src\analytics\site_inventory_health_analyzer.py:266` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-240** `src\api\tenant_fetch.py:139` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-241** `src\api\tenant_fetch.py:139` - STRUCT-BLOCKS (Structure)
  - Symbol: `_extract_tenants_from_networks`
...
- [ ] **CMP-242** `src\api\tenant_fetch.py:162` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-243** `src\api\tenant_fetch.py:162` - STRUCT-BLOCKS (Structure)
  - Symbol: `_extract_tenants_from_policy_item`
  - Problem: Function has 6 logical blocks (limit 5).
  - Fix: Split the function so each helper owns a single cohesive block of logic.
  - Done when: analyzer reports no STRUCT-BLOCKS for `_extract_tenants_from_policy_item` in `src\api\tenant_fetch.py`.
- [ ] **CMP-244** `src\api\tenant_fetch.py:197` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-245** `src\api\tenant_fetch.py:213` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-251** `src\auth\interactive\msp_org_selector.py:118` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-252** `src\auth\interactive\msp_org_selector.py:192` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-253** `src\bootstrap\dependency_check.py:60` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-254** `src\bootstrap\dependency_check.py:60` - STRUCT-BLOCKS (Structure)
  - Symbol: `_classify_packages`
  - Problem: Function has 6 logical blocks (limit 5).
  - Fix: Split the function so each helper owns a single cohesive block of logic.
  - Done when: analyzer reports no STRUCT-BLOCKS for `_classify_packages` in `src\bootstrap\dependency_check.py`.
- [ ] **CMP-255** `src\bootstrap\dependency_check.py:103` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-256** `src\bootstrap\dependency_check.py:126` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-257** `src\bootstrap\package_installer.py:19` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `find_uv_executable`
  - Problem: Cyclomatic complexity is 10 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `find_uv_executable` in `src\bootstrap\package_installer.py`.
- [ ] **CMP-258** `src\bootstrap\package_installer.py:19` - STRUCT-BLOCKS (Structure)
  - Symbol: `find_uv_executable`
  - Problem: Function has 8 logical blocks (limit 5).
  - Fix: Split the function so each helper owns a single cohesive block of logic.
  - Done when: analyzer reports no STRUCT-BLOCKS for `find_uv_executable` in `src\bootstrap\package_installer.py`.
- [ ] **CMP-259** `src\capture\packet_capture_download.py:18` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `fetch_completed_pcaps`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `fetch_completed_pcaps` in `src\capture\packet_capture_download.py`.
- [ ] **CMP-260** `src\capture\packet_capture_download.py:63` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `download_pending_pcaps`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `download_pending_pcaps` in `src\capture\packet_capture_download.py`.
- [ ] **CMP-261** `src\capture\packet_capture_download.py:174` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `poll_and_download_pcap`
  - Problem: Cyclomatic complexity is 7 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `poll_and_download_pcap` in `src\capture\packet_capture_download.py`.
- [ ] **CMP-262** `src\capture\packet_capture_download.py:235` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `poll_for_pcap_url`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `poll_for_pcap_url` in `src\capture\packet_capture_download.py`.
- [ ] **CMP-263** `src\capture\packet_capture_download.py:330` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `find_capture_url`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `find_capture_url` in `src\capture\packet_capture_download.py`.
- [ ] **CMP-264** `src\db\router.py:147` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_snapshot_if_config`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_snapshot_if_config` in `src\db\router.py`.
- [ ] **CMP-265** `src\export\device_events_52w_exporter.py:101` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-266** `src\export\site_insights_exporter.py:64` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-267** `src\export\wifi_clients_exporter.py:94` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-268** `src\export\wifi_clients_exporter.py:132` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_merge_clients_and_sessions`
  - Problem: Cyclomatic complexity is 7 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_merge_clients_and_sessions` in `src\export\wifi_clients_exporter.py`.
- [ ] **CMP-269** `src\gateway\device_template_cloner.py:253` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-270** `src\gateway\device_template_cloner.py:311` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-271** `src\gateway\device_template_cloner.py:398` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `clone`
  - Problem: Cyclomatic complexity is 7 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `clone` in `src\gateway\device_template_cloner.py`.
- [ ] **CMP-272** `src\gateway\device_template_cloner.py:398` - STRUCT-BLOCKS (Structure)
  - Symbol: `clone`
  - Problem: Function has 6 logical blocks (limit 5).
  - Fix: Split the function so each helper owns a single cohesive block of logic.
  - Done when: analyzer reports no STRUCT-BLOCKS for `clone` in `src\gateway\device_template_cloner.py`.
- [ ] **CMP-273** `src\gateway\gateway_export_utils.py:184` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_build_management_ip_rows`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_build_management_ip_rows` in `src\gateway\gateway_export_utils.py`.
- [ ] **CMP-274** `src\gateway\gateway_export_utils.py:235` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `management_ips`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `management_ips` in `src\gateway\gateway_export_utils.py`.
- [ ] **CMP-275** `src\gateway\gateway_export_utils.py:305` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_build_filtered_port_rows`
  - Problem: Cyclomatic complexity is 8 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_build_filtered_port_rows` in `src\gateway\gateway_export_utils.py`.
- [ ] **CMP-276** `src\gateway\gateway_export_utils.py:390` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_get_devices_from_cache`
  - Problem: Cyclomatic complexity is 8 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_get_devices_from_cache` in `src\gateway\gateway_export_utils.py`.
- [ ] **CMP-277** `src\gateway\gateway_export_utils.py:425` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_get_devices_from_api`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_get_devices_from_api` in `src\gateway\gateway_export_utils.py`.
- [ ] **CMP-278** `src\gateway\gateway_stats_exporter.py:87` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_fetch_one_device_stats`
  - Problem: Cyclomatic complexity is 7 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_fetch_one_device_stats` in `src\gateway\gateway_stats_exporter.py`.
- [ ] **CMP-279** `src\gateway\gateway_stats_exporter.py:87` - STRUCT-BLOCKS (Structure)
  - Symbol: `_fetch_one_device_stats`
  - Problem: Function has 6 logical blocks (limit 5).
  - Fix: Split the function so each helper owns a single cohesive block of logic.
  - Done when: analyzer reports no STRUCT-BLOCKS for `_fetch_one_device_stats` in `src\gateway\gateway_stats_exporter.py`.
- [ ] **CMP-280** `src\gateway\gateway_stats_exporter.py:195` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_export_stats`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_export_stats` in `src\gateway\gateway_stats_exporter.py`.
- [ ] **CMP-281** `src\gateway\gateway_stats_exporter.py:288` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_collect_device_wan_ips`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_collect_device_wan_ips` in `src\gateway\gateway_stats_exporter.py`.
- [ ] **CMP-282** `src\inventory\org_device_inventory_summary.py:43` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_fetch_switch_physical_inventory`
  - Problem: Cyclomatic complexity is 9 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_fetch_switch_physical_inventory` in `src\inventory\org_device_inventory_summary.py`.
- [ ] **CMP-283** `src\inventory\org_device_inventory_summary.py:43` - STRUCT-BLOCKS (Structure)
  - Symbol: `_fetch_switch_physical_inventory`
  - Problem: Function has 6 logical blocks (limit 5).
  - Fix: Split the function so each helper owns a single cohesive block of logic.
  - Done when: analyzer reports no STRUCT-BLOCKS for `_fetch_switch_physical_inventory` in `src\inventory\org_device_inventory_summary.py`.
- [ ] **CMP-284** `src\inventory\org_device_inventory_summary.py:210` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_aggregate_unassigned_counts`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_aggregate_unassigned_counts` in `src\inventory\org_device_inventory_summary.py`.
- [ ] **CMP-285** `src\inventory\org_device_inventory_summary.py:254` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_fetch_all_counts`
  - Problem: Cyclomatic complexity is 8 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_fetch_all_counts` in `src\inventory\org_device_inventory_summary.py`.
- [ ] **CMP-286** `src\inventory\org_device_inventory_summary.py:254` - STRUCT-BLOCKS (Structure)
  - Symbol: `_fetch_all_counts`
  - Problem: Function has 7 logical blocks (limit 5).
  - Fix: Split the function so each helper owns a single cohesive block of logic.
  - Done when: analyzer reports no STRUCT-BLOCKS for `_fetch_all_counts` in `src\inventory\org_device_inventory_summary.py`.
- [ ] **CMP-287** `src\inventory\org_device_inventory_summary.py:336` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_resolve_safe_org_name`
  - Problem: Cyclomatic complexity is 7 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_resolve_safe_org_name` in `src\inventory\org_device_inventory_summary.py`.
- [ ] **CMP-288** `src\maps\_maps_backup.py:37` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_backup_download_image`
  - Problem: Cyclomatic complexity is 9 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_backup_download_image` in `src\maps\_maps_backup.py`.
- [ ] **CMP-289** `src\maps\_maps_backup.py:37` - STRUCT-BLOCKS (Structure)
  - Symbol: `_backup_download_image`
  - Problem: Function has 6 logical blocks (limit 5).
  - Fix: Split the function so each helper owns a single cohesive block of logic.
  - Done when: analyzer reports no STRUCT-BLOCKS for `_backup_download_image` in `src\maps\_maps_backup.py`.
- [ ] **CMP-290** `src\maps\_maps_backup.py:75` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_backup_fetch_items`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_backup_fetch_items` in `src\maps\_maps_backup.py`.
- [ ] **CMP-291** `src\maps\_maps_backup.py:89` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_backup_fetch_device_placements`
  - Problem: Cyclomatic complexity is 8 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_backup_fetch_device_placements` in `src\maps\_maps_backup.py`.
- [ ] **CMP-292** `src\maps\_maps_backup.py:152` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_backup_print_summary`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_backup_print_summary` in `src\maps\_maps_backup.py`.
- [ ] **CMP-293** `src\maps\_maps_clone.py:127` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_download_clone_image`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_download_clone_image` in `src\maps\_maps_clone.py`.
- [ ] **CMP-294** `src\maps\_maps_clone.py:220` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_clone_zones`
  - Problem: Cyclomatic complexity is 7 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_clone_zones` in `src\maps\_maps_clone.py`.
- [ ] **CMP-295** `src\maps\_maps_clone.py:267` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `clone_map`
  - Problem: Cyclomatic complexity is 10 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `clone_map` in `src\maps\_maps_clone.py`.
- [ ] **CMP-296** `src\maps\_maps_clone.py:267` - STRUCT-BLOCKS (Structure)
  - Symbol: `clone_map`
  - Problem: Function has 8 logical blocks (limit 5).
  - Fix: Split the function so each helper owns a single cohesive block of logic.
  - Done when: analyzer reports no STRUCT-BLOCKS for `clone_map` in `src\maps\_maps_clone.py`.
- [ ] **CMP-297** `src\maps\_maps_matplotlib.py:38` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `_launch_matplotlib_viewer`
  - Problem: Cyclomatic complexity is 6 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
  - Done when: analyzer reports no STRUCT-COMPLEXITY for `_launch_matplotlib_viewer` in `src\maps\_maps_matplotlib.py`.
- [ ] **CMP-298** `src\maps\_maps_matplotlib.py:99` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-299** `src\maps\_maps_matplotlib.py:116` - STRUCT-COMPLEXITY (Complexity)
...
- [ ] **CMP-300** `src\maps\plotly_heatmap_renderer.py:18` - STRUCT-COMPLEXITY (Complexity)
  - Symbol: `build_heatmap_trace`
  - Problem: Cyclomatic complexity is 10 (target <= 5).
  - Fix: Reduce branching by extracting helpers, using guard clauses, or simplifying logic.
