...
def test_the_review_page_reads_the_projected_count_name() -> None:
    """Issue #2625: the page and the store name one field.

    Why:
        The review route holds its own copy of this name, because an import of
