...
def _build_app(allowed_ips: list, trusted_proxies: list | None = None) -> Flask:
    ...
    logger.info("Building a test portal with %d configured networks", len(allowed_ips))
    app = Flask(__name__)
    ...
    logger.debug("Built a test portal that serves one route")
    return app
...
def workstation(monkeypatch):
    ...
    logger.info("Forcing the container probe to report a workstation")
...
def container(monkeypatch):
    ...
    logger.info("Forcing the container probe to report a container")
...
class TestWorkstationDefaultRefusesRemoteClients:
    ...
    def test_a_public_client_is_refused(self, workstation) -> None:
        ...
        logger.info("Sending a request from a public address with no allowlist")
        ...
        logger.debug("The public address received %d", response.status_code)
    ...
    def test_a_lan_client_is_refused(self, workstation) -> None:
        ...
        logger.info("Sending a request from a LAN address with no allowlist")
        ...
        logger.debug("The LAN address received %d", response.status_code)

    def test_the_loopback_client_still_works(self, workstation) -> None:
        """The operator who runs the portal still reaches it."""
        logger.info("Sending a request from the loopback address with no allowlist")
        ...
        logger.debug("The loopback address received %d", response.status_code)
...
class TestContainerDefaultRefusesPublicClients:
    ...
    def test_a_public_client_is_refused(self, container) -> None:
        ...
        logger.info("Sending a request from a public address inside a container")
    ...
    def test_the_bridge_gateway_still_works(self, container) -> None:
        ...
        logger.info("Sending a request from the container bridge gateway")
        ...
        logger.debug("The bridge gateway received %d", response.status_code)

    def test_a_lan_client_still_works(self, container) -> None:
        """An operator on the office network still reaches a container portal."""
        logger.info("Sending a request from a LAN address inside a container")
    ...
    def test_the_loopback_client_still_works(self, container) -> None:
        ...
        logger.info("Sending a request from the loopback address inside a container")
...
class TestTheOperatorCanOptOut:
    ...
    def test_the_opt_out_serves_a_public_client(self, workstation, monkeypatch, value) -> None:
        ...
        logger.info("Setting the opt-out to %s and sending a public request", value)
        ...
        logger.debug("The opt-out value %s produced %d", value, response.status_code)
    ...
    def test_a_value_that_is_not_true_keeps_the_portal_closed(self, workstation, monkeypatch, value) -> None:
        ...
        logger.debug("The value %s produced %d", value, response.status_code)
    ...
    def test_the_opt_out_records_a_warning(self, workstation, monkeypatch, caplog) -> None:
        ...
        logger.info("Checking that the opt-out writes a warning to the log")
        ...
        logger.debug("The opt-out wrote %d characters to the log", len(caplog.text))
...
class TestAnExplicitAllowlistStillWins:
    ...
    def test_the_configured_network_is_served(self, workstation) -> None:
        ...
        logger.info("Applying an explicit allowlist and sending a matching request")
        ...
        logger.debug("The configured address received %d", response.status_code)
    ...
    def test_an_address_outside_the_configured_network_is_refused(self, workstation) -> None:
        ...
        logger.info("Applying an explicit allowlist and sending a loopback request")
...
class TestTheFallbackTellsTheOperatorWhatToDo:
    ...
    def test_the_workstation_fallback_writes_one_warning(self, workstation, caplog) -> None:
        ...
        logger.info("Checking the workstation fallback startup message")
        with caplog.at_level(logging.WARNING):
            _build_app([])
        ...
        logger.debug("The workstation fallback wrote a warning")
    ...
    def test_the_message_is_ascii(self, workstation, caplog) -> None:
        ...
        logger.debug("The startup message is ASCII")
