...
Lists authorized guests at a site. Returns guest WiFi users who have been granted access via captive portal, PSK, or admin action.

## Gotchas

- Only lists guests with active authorizations. Expired guests may not appear.
...
- [GET_sites_site_id_guests_guest_mac.md](GET_sites_site_id_guests_guest_mac.md) — Get specific guest
