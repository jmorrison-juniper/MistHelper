...
`mistapi.api.v1.sites.wxtags.listSiteWxTags()`

## Usage Context

Lists WxTags at a site. WxTags are labels used by WxRules to match clients, SSIDs, or applications.

## Gotchas

- WxTags must be created before they can be referenced in WxRules.

## Related Endpoints

- [GET_sites_site_id_wxtags_wxtag_id.md](GET_sites_site_id_wxtags_wxtag_id.md) — Get specific WxTag
- [GET_sites_site_id_wxrules.md](GET_sites_site_id_wxrules.md) — WxRules
