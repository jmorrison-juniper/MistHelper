...
`mistapi.api.v1.sites.wxtunnels.updateSiteWxTunnel()`

## Usage Context

Updates an existing WxLAN tunnel's configuration.

## Gotchas

- Tunnel changes may disrupt forwarded traffic during reconfiguration.

## Related Endpoints

- [GET_sites_site_id_wxtunnels_wxtunnel_id.md](GET_sites_site_id_wxtunnels_wxtunnel_id.md) — Tunnel details
- [GET_sites_site_id_wxtunnels.md](GET_sites_site_id_wxtunnels.md) — List tunnels
