...
`mistapi.api.v1.sites.stats_-_clients_wireless.getSiteWirelessClientsStatsByMap()`

## Usage Context

Retrieves client statistics for a specific map/floor at a site. Shows client locations on the floor plan.

## Gotchas

- Requires location services to be enabled for accurate client positioning.

## Related Endpoints

- [GET_sites_site_id_stats_maps_map_id_discovered_assets.md](GET_sites_site_id_stats_maps_map_id_discovered_assets.md) — Discovered assets on map
