...
`mistapi.api.v1.sites.alarms.UnsubscribeSiteAlarms()`

## Usage Context

Deletes a subscription from a site. Removes webhook or event subscriptions.

## Gotchas

- Any external integrations relying on this subscription will stop receiving events.
