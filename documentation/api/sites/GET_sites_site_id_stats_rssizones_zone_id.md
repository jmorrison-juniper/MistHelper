...
`GET /api/v1/sites/{site_id}/stats/rssizones/{zone_id}`
...
`mistapi.api.v1.sites.stats_-_zones.getSiteRssiZoneStats()`

## Usage Context

Retrieves statistics for a specific RSSI zone, including current client count and signal measurements.
...
- [GET_sites_site_id_stats_rssizones.md](GET_sites_site_id_stats_rssizones.md) — All RSSI zone stats
- [GET_sites_site_id_rssizones_rssizone_id.md](GET_sites_site_id_rssizones_rssizone_id.md) — RSSI zone config
