...
`mistapi.api.v1.sites.maps.updateSiteMap()`

## Usage Context

Updates a map's properties (name, position, dimensions, scale).

## Gotchas

- Changing scale or dimensions may invalidate AP positions. Verify after update.
