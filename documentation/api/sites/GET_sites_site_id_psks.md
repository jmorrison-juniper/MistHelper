...
Lists Pre-Shared Keys (PSKs) configured at a site. Returns key names, roles, VLAN assignments, and usage limits.

## Gotchas

- PSK passphrases may not be returned in full for security. Check the response schema.

## Related Endpoints

- [GET_sites_site_id_psks_psk_id.md](GET_sites_site_id_psks_psk_id.md) — Get specific PSK
