...
Updates guest authorization details for a specific client MAC address.

## Gotchas

- MAC must be in colon-separated format. Guest must have an existing authorization record.
