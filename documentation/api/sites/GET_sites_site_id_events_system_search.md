...
Searches system events at a site (infrastructure changes, cloud connectivity events, admin actions).

## Gotchas

- Uses cursor-based pagination. Specify `start`/`end` for bounded time queries.

## Related Endpoints

- [GET_sites_site_id_events_system_count.md](GET_sites_site_id_events_system_count.md) — Count system events
- [GET_sites_site_id_devices_events_search.md](GET_sites_site_id_devices_events_search.md) — Device events
