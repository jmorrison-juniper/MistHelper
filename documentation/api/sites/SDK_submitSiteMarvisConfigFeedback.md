...
> API Reference: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/sites/marvis-configs/submit-site-marvis-config-feedback
...
```python
submitSiteMarvisConfigFeedback(mist_session: mistapi.__api_session.APISession, site_id: str, id: str, body: dict | list) -> mistapi.__api_response.APIResponse
```
