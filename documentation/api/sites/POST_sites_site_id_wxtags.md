...
`mistapi.api.v1.sites.wxtags.createSiteWxTag()`

## Usage Context

Creates a new WxLAN tag at a site. Tags are used in WxRules to match traffic by application, user, or client.

## Gotchas

- Tag names must be unique within the site.

## Related Endpoints

- [GET_sites_site_id_wxtags.md](GET_sites_site_id_wxtags.md) — List WxTags
- [POST_sites_site_id_wxrules.md](POST_sites_site_id_wxrules.md) — Create WxRule
