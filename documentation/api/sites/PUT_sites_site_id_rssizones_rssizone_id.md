...
`mistapi.api.v1.sites.rssi_zones.updateSiteRssiZone()`

## Usage Context

Updates an RSSI zone's configuration (name, thresholds, map location).
...
- [GET_sites_site_id_rssizones.md](GET_sites_site_id_rssizones.md) — List zones
