...
`mistapi.api.v1.sites.vpns.listSiteVpnsDerived()`

## Usage Context

Retrieves the effective (derived/resolved) VPN configurations for a site, including WAN overlay VPN settings from org templates.

## Gotchas

- VPN derived config shows the actual tunnel endpoints and routing that gateways apply.

## Related Endpoints

- [../orgs/GET_orgs_org_id_vpns.md](../orgs/GET_orgs_org_id_vpns.md) — Org VPN definitions
- [GET_sites_site_id_gatewaytemplates_derived.md](GET_sites_site_id_gatewaytemplates_derived.md) — Derived gateway template
