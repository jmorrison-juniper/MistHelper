...
`mistapi.api.v1.sites.wxtunnels.getSiteWxTunnel()`

## Usage Context

Retrieves configuration details of a specific WxTunnel, including tunnel type, peers, and VLAN mappings.
...
- [PUT_sites_site_id_wxtunnels_wxtunnel_id.md](PUT_sites_site_id_wxtunnels_wxtunnel_id.md) — Update tunnel
- [DELETE_sites_site_id_wxtunnels_wxtunnel_id.md](DELETE_sites_site_id_wxtunnels_wxtunnel_id.md) — Delete tunnel
