...
`mistapi.api.v1.sites.mxedges.countSiteMxEdgeEvents()`

## Usage Context

Returns the count of Mist Edge events at a site.
...
- [GET_sites_site_id_mxedges_events_search.md](GET_sites_site_id_mxedges_events_search.md) — Search edge events
