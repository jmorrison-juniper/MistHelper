...
`mistapi.api.v1.sites.alarms.unackSiteAllAlarms()`

## Usage Context

Unacknowledges all alarms at a site in bulk, restoring them to active state.

## Gotchas

- Destructive operation: affects ALL acknowledged alarms.
