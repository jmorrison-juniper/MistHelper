...
`mistapi.api.v1.sites.clients_-_wan.countSiteWanClientEvents()`

## Usage Context

Returns the count of WAN client events at a site.

## Gotchas

- Requires SRX/SSR gateway with session logging enabled.

## Related Endpoints

- [GET_sites_site_id_wan_clients_events_search.md](GET_sites_site_id_wan_clients_events_search.md) — Search WAN client events
