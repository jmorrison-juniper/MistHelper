...
> API Reference: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/sites/auto-map-assignment/get-site-auto-map-assignment-status
...
```python
getSiteAutoMapAssignmentStatus(mist_session: mistapi.__api_session.APISession, site_id: str) -> mistapi.__api_response.APIResponse
```
