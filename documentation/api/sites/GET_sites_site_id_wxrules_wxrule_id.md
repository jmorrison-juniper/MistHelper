...
`mistapi.api.v1.sites.wxrules.getSiteWxRule()`

## Usage Context

Retrieves a specific WxRule by ID, including match criteria and actions.
...
- [PUT_sites_site_id_wxrules_wxrule_id.md](PUT_sites_site_id_wxrules_wxrule_id.md) — Update WxRule
- [DELETE_sites_site_id_wxrules_wxrule_id.md](DELETE_sites_site_id_wxrules_wxrule_id.md) — Delete WxRule
