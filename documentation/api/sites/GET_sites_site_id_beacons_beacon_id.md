...
Retrieves details of a specific BLE beacon at a site, including position, UUID, major/minor, and power settings.
...
- [PUT_sites_site_id_beacons_beacon_id.md](PUT_sites_site_id_beacons_beacon_id.md) — Update beacon
- [DELETE_sites_site_id_beacons_beacon_id.md](DELETE_sites_site_id_beacons_beacon_id.md) — Delete beacon
- [GET_sites_site_id_beacons.md](GET_sites_site_id_beacons.md) — List all beacons

## MistHelper Notes

Used by Menu **50** and Menu **112** (`MapsManagerLauncher`).
