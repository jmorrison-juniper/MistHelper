...
`mistapi.api.v1.sites.wxrules.createSiteWxRule()`

## Usage Context

Creates a new WxLAN rule at a site. WxRules control traffic forwarding between WLANs and network segments.

## Gotchas

- Rule order matters. Rules are evaluated top-down; place more specific rules first.

## Related Endpoints

- [GET_sites_site_id_wxrules.md](GET_sites_site_id_wxrules.md) — List WxRules
