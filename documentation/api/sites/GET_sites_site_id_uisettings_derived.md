...
`mistapi.api.v1.sites.ui_settings.listSiteUiSettingDerived()`

## Usage Context

Retrieves the effective (derived/resolved) UI settings for a site dashboard, including inherited org configurations.

## Gotchas

- UI settings are presentation-only; they do not affect device configuration.

## Related Endpoints

- [GET_sites_site_id_uisettings.md](GET_sites_site_id_uisettings.md) — List raw UI settings
