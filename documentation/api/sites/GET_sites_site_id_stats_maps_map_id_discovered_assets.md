...
`mistapi.api.v1.sites.stats_-_assets.getSiteDiscoveredAssetByMap()`

## Usage Context

Retrieves discovered BLE assets on a specific map/floor. Shows asset positions on the floor plan.

## Gotchas

- Accuracy depends on AP density and BLE scanning configuration.

## Related Endpoints

- [GET_sites_site_id_stats_maps_map_id_clients.md](GET_sites_site_id_stats_maps_map_id_clients.md) — Clients on map
- [GET_sites_site_id_stats_discovered_assets.md](GET_sites_site_id_stats_discovered_assets.md) — All discovered assets
