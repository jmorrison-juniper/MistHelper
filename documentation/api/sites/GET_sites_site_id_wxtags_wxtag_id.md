...
`mistapi.api.v1.sites.wxtags.getSiteWxTag()`

## Usage Context

Retrieves a specific WxTag by ID, including the tag type and match criteria.
...
- [PUT_sites_site_id_wxtags_wxtag_id.md](PUT_sites_site_id_wxtags_wxtag_id.md) — Update WxTag
- [DELETE_sites_site_id_wxtags_wxtag_id.md](DELETE_sites_site_id_wxtags_wxtag_id.md) — Delete WxTag
