...
`mistapi.api.v1.sites.maps.createSiteMap()`

## Usage Context

Creates a new map (floor plan) at a site.

## Gotchas

- Map name must be unique within the site.

## Related Endpoints

- [POST_sites_site_id_maps_import.md](POST_sites_site_id_maps_import.md) — Import maps
