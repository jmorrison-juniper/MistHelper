...
`mistapi.api.v1.sites.rfdiags.updateSiteRfdiagRecording()`

## Usage Context

Updates an RF diagnostics recording session's metadata.
...
- [POST_sites_site_id_rfdiags.md](POST_sites_site_id_rfdiags.md) — Start RFdiag
