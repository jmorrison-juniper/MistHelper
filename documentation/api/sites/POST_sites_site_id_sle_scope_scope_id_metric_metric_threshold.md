...
`mistapi.api.v1.sites.sles.replaceSiteSleThreshold()`

## Usage Context

Sets custom SLE (Service Level Expectation) thresholds for a specific scope and metric at a site.

## Gotchas

- Threshold values must be within valid ranges for the specific metric.
...
- [PUT_sites_site_id_sle_scope_scope_id_metric_metric_threshold.md](PUT_sites_site_id_sle_scope_scope_id_metric_metric_threshold.md) — Update thresholds
