...
`mistapi.api.v1.sites.vbeacons.getSiteVBeacon()`

## Usage Context

Retrieves details of a specific virtual beacon, including UUID, major, minor, and position on the map.
...
- [PUT_sites_site_id_vbeacons_vbeacon_id.md](PUT_sites_site_id_vbeacons_vbeacon_id.md) — Update vbeacon
- [DELETE_sites_site_id_vbeacons_vbeacon_id.md](DELETE_sites_site_id_vbeacons_vbeacon_id.md) — Delete vbeacon
