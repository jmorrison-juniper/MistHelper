...
`mistapi.api.v1.sites.asset_filters.createSiteAssetFilter()`

## Usage Context

Creates a new BLE asset filter at a site. Asset filters control which BLE devices are tracked.

## Gotchas

- Filter order matters; filters are evaluated sequentially.

## Related Endpoints

- [GET_sites_site_id_assetfilters.md](GET_sites_site_id_assetfilters.md) — List asset filters
