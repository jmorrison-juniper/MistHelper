...
`mistapi.api.v1.sites.psks.getSitePsk()`

## Usage Context

Retrieves details of a specific PSK at a site, including role, VLAN, expiry, and usage.
...
- [PUT_sites_site_id_psks_psk_id.md](PUT_sites_site_id_psks_psk_id.md) — Update PSK
- [DELETE_sites_site_id_psks_psk_id.md](DELETE_sites_site_id_psks_psk_id.md) — Delete PSK
- [GET_sites_site_id_psks.md](GET_sites_site_id_psks.md) — List all PSKs
