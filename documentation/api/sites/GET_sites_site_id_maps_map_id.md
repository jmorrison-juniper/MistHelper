...
`mistapi.api.v1.sites.maps.getSiteMap()`

## Usage Context

Retrieves details of a specific map, including dimensions, AP positions, wall paths, zones, and image reference.

## Gotchas

- AP positions on the map are stored as x/y coordinates relative to map dimensions.

## Related Endpoints

- [PUT_sites_site_id_maps_map_id.md](PUT_sites_site_id_maps_map_id.md) — Update map
- [DELETE_sites_site_id_maps_map_id.md](DELETE_sites_site_id_maps_map_id.md) — Delete map
- [POST_sites_site_id_maps_map_id_image.md](POST_sites_site_id_maps_map_id_image.md) — Upload image

## MistHelper Notes

Used by Menu **112** (`MapsManagerLauncher`) for map detail operations.
