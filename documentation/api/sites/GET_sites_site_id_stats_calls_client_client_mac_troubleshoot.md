...
|------|------|----------|---------|------|-------------|
| meeting_id | string | Yes |  |  | meeting_id |
...
`mistapi.api.v1.sites.stats_-_calls.troubleshootSiteCall()`

## Usage Context

Provides per-client call troubleshooting data, correlating call quality issues with specific client RF conditions.

## Gotchas

- The `client_mac` path parameter must be a valid MAC address format.

## Related Endpoints

- [GET_sites_site_id_stats_calls_troubleshoot.md](GET_sites_site_id_stats_calls_troubleshoot.md) — Site-level troubleshoot
- [GET_sites_site_id_stats_clients_client_mac.md](GET_sites_site_id_stats_clients_client_mac.md) — Client stats
