...
`mistapi.api.v1.sites.vbeacons.updateSiteVBeacon()`

## Usage Context

Updates a virtual beacon's configuration (position, power, UUID).
...
- [GET_sites_site_id_vbeacons_vbeacon_id.md](GET_sites_site_id_vbeacons_vbeacon_id.md) — Beacon details
- [POST_sites_site_id_vbeacons.md](POST_sites_site_id_vbeacons.md) — Create beacon
