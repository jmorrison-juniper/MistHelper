...
`mistapi.api.v1.sites.mxedges.updateSiteMxEdge()`

## Usage Context

Updates a Mist Edge appliance's configuration at a site.

## Gotchas

- Configuration changes may trigger a service restart on the Mist Edge.
