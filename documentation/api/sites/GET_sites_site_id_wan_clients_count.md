...
`mistapi.api.v1.sites.clients_-_wan.countSiteWanClients()`

## Usage Context

Returns the count of WAN clients at a site (devices behind the gateway).
...
- [GET_sites_site_id_wan_client_events_count.md](GET_sites_site_id_wan_client_events_count.md) — WAN client events count
