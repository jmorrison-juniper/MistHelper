...
`mistapi.api.v1.sites.ui_settings.createSiteUiSettings()`

## Usage Context

Creates a new UI settings entry for a site. Stores dashboard layout and display preferences.
...
- [POST_sites_site_id_uisettings_uisetting_id.md](POST_sites_site_id_uisettings_uisetting_id.md) — Update specific setting
