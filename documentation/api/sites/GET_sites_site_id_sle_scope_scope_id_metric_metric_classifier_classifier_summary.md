...
`mistapi.api.v1.sites.sles.getSiteSleClassifierDetails()`

## Usage Context

Retrieves summary data for a specific SLE classifier, showing the distribution of failures across that root cause category.

## Gotchas

- Requires valid classifier name from the classifiers endpoint.

## Related Endpoints

- [GET_sites_site_id_sle_scope_scope_id_metric_metric_classifier_classifier_summary-trend.md](GET_sites_site_id_sle_scope_scope_id_metric_metric_classifier_classifier_summary-trend.md) — Classifier trend
- [GET_sites_site_id_sle_scope_scope_id_metric_metric_classifiers.md](GET_sites_site_id_sle_scope_scope_id_metric_metric_classifiers.md) — List classifiers
