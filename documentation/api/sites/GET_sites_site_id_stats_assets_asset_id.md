...
`mistapi.api.v1.sites.stats_-_assets.getSiteAssetStats()`

## Usage Context

Retrieves statistics for a specific BLE asset by asset ID, including last-known position and signal data.

## Gotchas

- Asset must be registered/configured at the site level.
