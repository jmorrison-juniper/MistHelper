...
`mistapi.api.v1.sites.webhooks.getSiteWebhook()`

## Usage Context

Retrieves configuration details of a specific webhook, including URL, events, and authentication settings.

## Gotchas

- Webhook secrets are typically not returned in plaintext for security.

## Related Endpoints

- [PUT_sites_site_id_webhooks_webhook_id.md](PUT_sites_site_id_webhooks_webhook_id.md) — Update webhook
- [DELETE_sites_site_id_webhooks_webhook_id.md](DELETE_sites_site_id_webhooks_webhook_id.md) — Delete webhook
