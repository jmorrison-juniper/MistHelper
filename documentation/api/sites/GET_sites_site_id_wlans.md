...
Lists all WLANs (SSIDs) configured at a site, including authentication, VLAN, and radio settings.

## Gotchas

- Site WLANs can be overridden by template WLANs. Check `template_id` field to distinguish.

## Related Endpoints

- [GET_sites_site_id_wlans_wlan_id.md](GET_sites_site_id_wlans_wlan_id.md) — Get specific WLAN
- [POST_sites_site_id_wlans.md](POST_sites_site_id_wlans.md) — Create WLAN

## MistHelper Notes

Used by Menus **49, 102, 118** via `listSiteWlans` for WLAN inventory and configuration.
