...
| mxedge_id | string | No |  |  | ID of Mist Edge that the client is connected through |
...
| ssid | string | No |  |  | SSID |
| status | string | No |  |  | Connection status of client i.e "permitted", "denied, "session_ended" |
...
`mistapi.api.v1.sites.clients_-_nac.searchSiteNacClients()`

## Usage Context

Searches for NAC clients at a site. Supports filtering by MAC, username, VLAN, and authentication status.
...
- [GET_sites_site_id_nac_clients_count.md](GET_sites_site_id_nac_clients_count.md) — Client count
- [GET_sites_site_id_nac_clients_events_search.md](GET_sites_site_id_nac_clients_events_search.md) — Client events
