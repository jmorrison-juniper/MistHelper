...
`mistapi.api.v1.sites.beacons.updateSiteBeacon()`

## Usage Context

Updates a BLE beacon's configuration (name, position, power, UUID).

## Gotchas

- Changing beacon UUID/major/minor requires re-configuration of client apps.
