...
`mistapi.api.v1.sites.wxtunnels.listSiteWxTunnels()`

## Usage Context

Lists WxTunnels (WLAN tunneling configurations) at a site. WxTunnels define how WLAN traffic is tunneled.

## Gotchas

- WxTunnels are typically configured at the org/template level and inherited.

## Related Endpoints

- [GET_sites_site_id_wxtunnels_wxtunnel_id.md](GET_sites_site_id_wxtunnels_wxtunnel_id.md) — Get specific tunnel
- [POST_sites_site_id_wxtunnels.md](POST_sites_site_id_wxtunnels.md) — Create tunnel
