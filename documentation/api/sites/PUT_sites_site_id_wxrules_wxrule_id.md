...
`mistapi.api.v1.sites.wxrules.updateSiteWxRule()`

## Usage Context

Updates an existing WxLAN rule's configuration.

## Gotchas

- Rule order matters. Changing rule properties may affect traffic matching.

## Related Endpoints

- [GET_sites_site_id_wxrules_wxrule_id.md](GET_sites_site_id_wxrules_wxrule_id.md) — Rule details
- [GET_sites_site_id_wxrules.md](GET_sites_site_id_wxrules.md) — List rules
