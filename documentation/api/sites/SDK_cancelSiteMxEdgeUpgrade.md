...
> API Reference: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/utilities/upgrade/cancel-site-mx-edge-upgrade
...
```python
cancelSiteMxEdgeUpgrade(mist_session: mistapi.__api_session.APISession, site_id: str, upgrade_id: str) -> mistapi.__api_response.APIResponse
```
