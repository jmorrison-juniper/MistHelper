...
> API Reference: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/sites/maps/add-site-map-image
...
```python
addSiteMapImageFile(mist_session: mistapi.__api_session.APISession, site_id: str, map_id: str, file: str | None = None, json: str | None = None) -> mistapi.__api_response.APIResponse
```
