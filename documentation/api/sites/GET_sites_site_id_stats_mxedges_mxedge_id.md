...
`mistapi.api.v1.sites.stats_-_mxedges.getSiteMxEdgeStats()`

## Usage Context

Retrieves detailed statistics for a specific Mist Edge appliance, including CPU, memory, tunnel counts, and throughput.
...
- [GET_sites_site_id_stats_mxedges.md](GET_sites_site_id_stats_mxedges.md) — All Mist Edge stats
