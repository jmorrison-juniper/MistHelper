...
`mistapi.api.v1.sites.alarms.unackSiteMultipleAlarms()`

## Usage Context

Unacknowledges specific alarms at a site by providing a list of alarm IDs.

## Gotchas

- Requires valid alarm IDs.

## Related Endpoints

- [POST_sites_site_id_alarms_unack_all.md](POST_sites_site_id_alarms_unack_all.md) — Unack all
