...
> API Reference: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/sites/devices/wireless/enable-site-device-zigbee-join
...
```python
enableSiteDeviceZigbeeJoin(mist_session: mistapi.__api_session.APISession, site_id: str, device_id: str, body: dict | list) -> mistapi.__api_response.APIResponse
```
