...
Searches alarms at a site with filtering by type, severity, time range, and acknowledgement status. Returns full alarm details.

## Gotchas

- Uses cursor-based pagination. Check `next` in response for additional pages.
- Time range defaults may vary; specify `start` and `end` explicitly for consistent results.

## Related Endpoints

- [GET_sites_site_id_alarms_count.md](GET_sites_site_id_alarms_count.md) — Count alarms
- [POST_sites_site_id_alarms_ack.md](POST_sites_site_id_alarms_ack.md) — Acknowledge alarms
- [POST_sites_site_id_alarms_unack.md](POST_sites_site_id_alarms_unack.md) — Unacknowledge alarms
