...
`mistapi.api.v1.sites.gateway_templates.listSiteGatewayTemplatesDerived()`

## Usage Context

Retrieves the effective (derived/resolved) gateway template for a site, including WAN/routing config from org templates.

## Gotchas

- Gateway templates define WAN interfaces, routing, and VPN. The derived view shows the actual applied config.

## Related Endpoints

- [../orgs/GET_orgs_org_id_gatewaytemplates.md](../orgs/GET_orgs_org_id_gatewaytemplates.md) — Org gateway templates
- [GET_sites_site_id_setting.md](GET_sites_site_id_setting.md) — Site settings

## MistHelper Notes

Not currently used by MistHelper directly. Menu **44** uses `listOrgGatewayTemplates` at org level.
