...
`mistapi.api.v1.sites.psks.updateSiteMultiplePsks()`

## Usage Context

Bulk-updates multiple PSKs at a site in a single request.

## Gotchas

- This replaces all PSKs. Omitting a PSK from the list deletes it.

## Related Endpoints

- [PUT_sites_site_id_psks_psk_id.md](PUT_sites_site_id_psks_psk_id.md) — Update single PSK
