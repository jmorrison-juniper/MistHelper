...
`mistapi.api.v1.sites.services.countSiteServicePathEvents()`

## Usage Context

Returns the count of service events (application/policy events) at a site.

## Gotchas

- Count only; use the search endpoint for details.

## Related Endpoints

- [GET_sites_site_id_services_events_search.md](GET_sites_site_id_services_events_search.md) — Search service events
