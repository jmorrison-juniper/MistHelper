...
Creates a new EVPN topology at a site. Defines EVPN-VXLAN fabric configuration.

## Gotchas

- EVPN topology creation affects switch configurations. Plan carefully before deployment.
