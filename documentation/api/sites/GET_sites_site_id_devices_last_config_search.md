...
Searches the last pushed configuration for devices at a site. Shows what config each device actually received.

## Gotchas

- The last config may differ from the current desired config if a push is pending or failed.
- Uses cursor-based pagination.

## Related Endpoints

- [GET_sites_site_id_devices_last_config_count.md](GET_sites_site_id_devices_last_config_count.md) — Count last configs
