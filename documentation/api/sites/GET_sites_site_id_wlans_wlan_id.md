...
`mistapi.api.v1.sites.wlans.getSiteWlan()`

## Usage Context

Retrieves detailed configuration of a specific WLAN (SSID) by ID.

## Gotchas

- Template-applied WLANs may show limited editable fields.

## Related Endpoints

- [PUT_sites_site_id_wlans_wlan_id.md](PUT_sites_site_id_wlans_wlan_id.md) — Update WLAN
- [DELETE_sites_site_id_wlans_wlan_id.md](DELETE_sites_site_id_wlans_wlan_id.md) — Delete WLAN

## MistHelper Notes

Not currently used by MistHelper directly (uses `listSiteWlans` for bulk retrieval).
