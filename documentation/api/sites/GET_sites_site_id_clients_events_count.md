...
`mistapi.api.v1.sites.clients_-_wireless.countSiteWirelessClientEvents()`

## Usage Context

Returns the count of wireless client events at a site, filtered by event type, time range, or client MAC.
...
- [GET_sites_site_id_clients_events_search.md](GET_sites_site_id_clients_events_search.md) — Search client events
- [GET_sites_site_id_clients_search.md](GET_sites_site_id_clients_search.md) — Search clients

## MistHelper Notes

Not currently used by MistHelper directly. Menu **30** uses `searchSiteWirelessClients`.
