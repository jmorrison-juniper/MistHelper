...
`mistapi.api.v1.sites.wxrules.ListSiteWxRulesDerived()`

## Usage Context

Retrieves the effective (derived/resolved) WxLAN rules for a site, including inherited org-level rules.

## Gotchas

- Derived rules show the complete access control rule set actually enforced at the site.

## Related Endpoints

- [GET_sites_site_id_wxrules.md](GET_sites_site_id_wxrules.md) — List raw site WxLAN rules
- [GET_sites_site_id_wxtags.md](GET_sites_site_id_wxtags.md) — WxLAN tags used in rules
