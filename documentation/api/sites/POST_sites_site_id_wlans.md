...
`mistapi.api.v1.sites.wlans.createSiteWlan()`

## Usage Context

Creates a new WLAN (wireless network/SSID) at a site.

## Gotchas

- SSID name must be unique within the site. Maximum of 15 SSIDs per radio band.
...
Not currently used by MistHelper directly for creation, but WLANs are managed via `updateSiteWlan` in Menus 49, 102.
