...
`mistapi.api.v1.sites.sles.listSiteSleImpactedChassis()`

## Usage Context

Lists chassis impacted by SLE failures. Relevant for virtual chassis (VC) and modular switch deployments.

## Gotchas

- Only relevant for switch SLE scopes with virtual chassis configurations.
