...
> API Reference: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/sites/clients/nac/send-site-nac-client-co-a

## Module

`mistapi.api.v1.sites.nac_clients`

## Signature

```python
sendSiteNacClientCoA(mist_session: mistapi.__api_session.APISession, site_id: str, client_mac: str, body: dict | list) -> mistapi.__api_response.APIResponse
```
