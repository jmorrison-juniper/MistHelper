...
`mistapi.api.v1.sites.networks.listSiteNetworksDerived()`

## Usage Context

Retrieves the effective (derived/resolved) network definitions for a site, merging org-level networks with site overrides.

## Gotchas

- Network VLANs and subnets shown here are what devices actually apply.

## Related Endpoints

- [../orgs/GET_orgs_org_id_networks.md](../orgs/GET_orgs_org_id_networks.md) — Org networks
- [GET_sites_site_id_setting.md](GET_sites_site_id_setting.md) — Site settings

## MistHelper Notes

Not currently used by MistHelper directly. Menu **47** uses `listOrgNetworks` at org level.
