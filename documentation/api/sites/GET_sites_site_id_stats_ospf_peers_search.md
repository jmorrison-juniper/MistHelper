...
`GET /api/v1/sites/{site_id}/stats/ospf_peers/search`
...
`mistapi.api.v1.sites.stats_-_ospf.searchSiteOspfStats()`

## Usage Context

Searches OSPF peer statistics at a site. Shows neighbor state, area ID, and adjacency details.
...
- [GET_sites_site_id_stats_ospf_peers_count.md](GET_sites_site_id_stats_ospf_peers_count.md) — Count OSPF peers
