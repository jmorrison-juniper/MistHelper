...
`mistapi.api.v1.sites.services.listSiteServicesDerived()`

## Usage Context

Retrieves the effective (derived/resolved) service definitions for a site. Services are application/traffic type definitions used in policies.

## Gotchas

- Used in conjunction with service policies to define what traffic classes are allowed/denied.

## Related Endpoints

- [../orgs/GET_orgs_org_id_services.md](../orgs/GET_orgs_org_id_services.md) — Org services
- [GET_sites_site_id_servicepolicies_derived.md](GET_sites_site_id_servicepolicies_derived.md) — Derived service policies
