...
`mistapi.api.v1.sites.devices_-_others.countSiteOtherDeviceEvents()`

## Usage Context

Returns the count of events for non-Juniper devices (other devices) at a site.
...
- [GET_sites_site_id_otherdevices_events_search.md](GET_sites_site_id_otherdevices_events_search.md) — Search events
