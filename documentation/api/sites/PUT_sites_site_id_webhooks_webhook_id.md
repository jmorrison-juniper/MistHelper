...
`mistapi.api.v1.sites.webhooks.updateSiteWebhook()`

## Usage Context

Updates a webhook's configuration (URL, topics, headers, secret).

## Gotchas

- Changing the webhook URL requires re-verifying endpoint connectivity.
