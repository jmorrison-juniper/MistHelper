...
`mistapi.api.v1.sites.wxrules.listSiteWxRules()`

## Usage Context

Lists WxRules (WLAN restriction rules) at a site. WxRules control client access based on tags.

## Gotchas

- WxRules use WxTags for matching. Ensure tags are configured before rules.

## Related Endpoints

- [GET_sites_site_id_wxrules_wxrule_id.md](GET_sites_site_id_wxrules_wxrule_id.md) — Get specific WxRule
- [GET_sites_site_id_wxtags.md](GET_sites_site_id_wxtags.md) — WxTags
