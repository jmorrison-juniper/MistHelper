...
`mistapi.api.v1.sites.evpn_topologies.getSiteEvpnTopology()`

## Usage Context

Retrieves a specific EVPN topology configuration at a site.
...
- [PUT_sites_site_id_evpn_topologies_evpn_topology_id.md](PUT_sites_site_id_evpn_topologies_evpn_topology_id.md) — Update topology
- [DELETE_sites_site_id_evpn_topologies_evpn_topology_id.md](DELETE_sites_site_id_evpn_topologies_evpn_topology_id.md) — Delete topology
