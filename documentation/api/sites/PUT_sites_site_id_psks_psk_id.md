...
`mistapi.api.v1.sites.psks.updateSitePsk()`

## Usage Context

Updates an existing Pre-Shared Key (PSK) at a site.

## Gotchas

- Changing the passphrase disconnects devices using the old key.

## Related Endpoints

- [GET_sites_site_id_psks.md](GET_sites_site_id_psks.md) — List PSKs
- [POST_sites_site_id_psks.md](POST_sites_site_id_psks.md) — Create PSK

## MistHelper Notes

Used by MistHelper via `createSitePsk` in Menu 108 (PSK management).
