...
`mistapi.api.v1.installer.installer.createInstallerMap()`

## Usage Context

Use this endpoint to create a new floor map for a site during installation. Common use cases:

- Adding a floor plan image for a new site
- Creating maps for AP placement planning during field deployment

## Gotchas

- The `{map_id}` in the URL is the identifier for the new map being created
- Map image upload may require a separate call depending on the format
- Uses site name (`{site_name}`) instead of site ID

## Related Endpoints

- [GET_installer_orgs_org_id_sites_site_name_maps.md](GET_installer_orgs_org_id_sites_site_name_maps.md) -- List existing maps
- [PUT_installer_orgs_org_id_sites_site_name_maps_map_id.md](PUT_installer_orgs_org_id_sites_site_name_maps_map_id.md) -- Update the map
- [DELETE_installer_orgs_org_id_sites_site_name_maps_map_id.md](DELETE_installer_orgs_org_id_sites_site_name_maps_map_id.md) -- Delete the map
- [../sites/POST_sites_site_id_maps.md](../sites/POST_sites_site_id_maps.md) -- Full admin map creation
