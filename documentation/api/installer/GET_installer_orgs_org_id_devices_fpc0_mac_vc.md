...
Use this endpoint to check the virtual chassis (VC) status of a switch stack. Common use cases:

- Verifying VC formation status during switch stack installation
- Checking member switch roles (master, backup, linecard) in the VC

## Gotchas

- The `{fpc0_mac}` parameter is the MAC address of the FPC0 (primary/master) switch in the VC
- Only applies to switch models that support virtual chassis (EX series)
- Returns empty or error for standalone switches not configured as VC

## Related Endpoints

- [POST_installer_orgs_org_id_devices_fpc0_mac_vc.md](POST_installer_orgs_org_id_devices_fpc0_mac_vc.md) -- Create a virtual chassis
- [PUT_installer_orgs_org_id_devices_fpc0_mac_vc.md](PUT_installer_orgs_org_id_devices_fpc0_mac_vc.md) -- Update VC configuration
- [../sites/GET_sites_site_id_devices_device_id_vc.md](../sites/GET_sites_site_id_devices_device_id_vc.md) -- Full admin VC status endpoint
