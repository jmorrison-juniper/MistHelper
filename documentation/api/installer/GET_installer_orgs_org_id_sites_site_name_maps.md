...
`mistapi.api.v1.installer.installer.listInstallerMaps()`

## Usage Context

Use this endpoint to list floor maps for a specific site. Common use cases:

- Viewing available maps during AP installation to select placement locations
- Checking which maps exist before uploading new ones

## Gotchas

- Uses `{site_name}` instead of site ID (installer API convention)
- Returns basic map metadata; for full map details with AP placement data, use the admin API

## Related Endpoints

- [POST_installer_orgs_org_id_sites_site_name_maps_map_id.md](POST_installer_orgs_org_id_sites_site_name_maps_map_id.md) -- Create a new map
- [PUT_installer_orgs_org_id_sites_site_name_maps_map_id.md](PUT_installer_orgs_org_id_sites_site_name_maps_map_id.md) -- Update a map
- [DELETE_installer_orgs_org_id_sites_site_name_maps_map_id.md](DELETE_installer_orgs_org_id_sites_site_name_maps_map_id.md) -- Delete a map
- [POST_installer_orgs_org_id_sites_site_name_maps_import.md](POST_installer_orgs_org_id_sites_site_name_maps_import.md) -- Import map data
- [../sites/GET_sites_site_id_maps.md](../sites/GET_sites_site_id_maps.md) -- Full admin map list

## MistHelper Notes

Not currently used by MistHelper. MistHelper uses the full admin-level map APIs (Menu **51**, **112**).
