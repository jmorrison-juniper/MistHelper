...
> API Reference: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/msps/sso/delete-msp-sso-admins
...
```python
deleteMspSsoAdmins(mist_session: mistapi.__api_session.APISession, msp_id: str, sso_id: str, body: dict | list) -> mistapi.__api_response.APIResponse
```
