...
`mistapi.api.v1.msps.admins.updateMspAdmin()`

## Usage Context

Updates an MSP administrator's role, privileges, or other settings. Use this to promote/demote admins or adjust their access scope across MSP-managed organizations.

## Gotchas

- Cannot demote yourself if you are the only super-admin.
- Role changes take effect immediately for the target admin's active sessions.

## Related Endpoints

- [GET_msps_msp_id_admins_admin_id.md](GET_msps_msp_id_admins_admin_id.md) — Get current admin details before updating
- [GET_msps_msp_id_admins.md](GET_msps_msp_id_admins.md) — List all admins
- [DELETE_msps_msp_id_admins_admin_id.md](DELETE_msps_msp_id_admins_admin_id.md) — Revoke admin access entirely
