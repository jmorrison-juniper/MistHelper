...
`GET /api/v1/msps/{msp_id}/ssos/{sso_id}`
...
`mistapi.api.v1.msps.sso.getMspSso()`

## Usage Context

Retrieves the details of a specific MSP SSO configuration, including IdP entity ID, SSO URL, certificate, and attribute mappings.

## Gotchas

- Sensitive fields like certificates may be partially redacted in the response.
- No known gotchas with the endpoint itself.

## Related Endpoints

- [GET_msps_msp_id_ssos.md](GET_msps_msp_id_ssos.md) — List all SSO configurations
- [PUT_msps_msp_id_ssos_sso_id.md](PUT_msps_msp_id_ssos_sso_id.md) — Update this SSO configuration
- [DELETE_msps_msp_id_ssos_sso_id.md](DELETE_msps_msp_id_ssos_sso_id.md) — Delete this SSO configuration
- [GET_msps_msp_id_ssos_sso_id_metadata.md](GET_msps_msp_id_ssos_sso_id_metadata.md) — Get SAML metadata for IdP setup
