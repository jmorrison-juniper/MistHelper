...
`mistapi.api.v1.msps.admins.getMspAdmin()`

## Usage Context

Retrieves details of a specific MSP administrator, including email, role, privileges, and last login information. Use this to verify an admin's access level or audit their activity.
...
- [GET_msps_msp_id_admins.md](GET_msps_msp_id_admins.md) — List all MSP admins
- [PUT_msps_msp_id_admins_admin_id.md](PUT_msps_msp_id_admins_admin_id.md) — Update this admin's role
- [DELETE_msps_msp_id_admins_admin_id.md](DELETE_msps_msp_id_admins_admin_id.md) — Revoke this admin's access
