...
`mistapi.api.v1.msps.sso_roles.updateMspSsoRole()`

## Usage Context

Updates an existing SSO role mapping, such as changing the mapped privilege level or the IdP attribute value. Use this when IdP group names change or administrative roles need adjustment.

## Gotchas

- Changes take effect on next SSO login for affected administrators, not retroactively on active sessions.

## Related Endpoints

- [GET_msps_msp_id_ssoroles.md](GET_msps_msp_id_ssoroles.md) — List all role mappings
- [DELETE_msps_msp_id_ssoroles_ssorole_id.md](DELETE_msps_msp_id_ssoroles_ssorole_id.md) — Delete this role mapping
