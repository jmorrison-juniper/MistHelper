...
`mistapi.api.v1.orgs.tickets.listOrgTickets()`

## Usage Context

Lists all support tickets for the organization.
...
- [GET_orgs_org_id_tickets_ticket_id.md](GET_orgs_org_id_tickets_ticket_id.md) — Get specific ticket
- [GET_orgs_org_id_tickets_count.md](GET_orgs_org_id_tickets_count.md) — Count tickets
