...
`mistapi.api.v1.orgs.wlan_templates.cloneOrgTemplate()`

## Usage Context

Clones an existing template to create a copy.

## Gotchas

- The cloned template is independent and can be modified without affecting the original.
...
Template listing uses Menu 34 (`listOrgTemplates`). Cloning is not used directly.
