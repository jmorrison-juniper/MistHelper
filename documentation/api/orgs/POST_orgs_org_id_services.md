...
`mistapi.api.v1.orgs.services.createOrgService()`

## Usage Context

Creates a new service (application definition) in the organization.

## Gotchas

- Services define applications for use in service policies and firewall rules.

## Related Endpoints

- [GET_orgs_org_id_services.md](GET_orgs_org_id_services.md) — List services
- [POST_orgs_org_id_servicepolicies.md](POST_orgs_org_id_servicepolicies.md) — Create service policy

## MistHelper Notes

Service listing uses Menu 4 (`listOrgServices`). Creation is not used directly.
