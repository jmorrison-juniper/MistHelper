...
`mistapi.api.v1.orgs.mxedges.createOrgMxEdge()`

## Usage Context

Creates a new Mist Edge appliance in the organization.

## Gotchas

- Mist Edges are typically claimed rather than created manually.
