...
`mistapi.api.v1.orgs.mxtunnels.getOrgMxTunnel()`

## Usage Context

Retrieves a specific Mist tunnel configuration by ID.

## Gotchas

- Tunnels define VLAN tunneling between APs and Mist Edge.

## Related Endpoints

- [GET_orgs_org_id_mxtunnels.md](GET_orgs_org_id_mxtunnels.md) — List tunnels
- [PUT_orgs_org_id_mxtunnels_mxtunnel_id.md](PUT_orgs_org_id_mxtunnels_mxtunnel_id.md) — Update tunnel
