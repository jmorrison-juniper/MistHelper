...
`mistapi.api.v1.orgs.network_templates.createOrgNetworkTemplate()`

## Usage Context

Creates a new network template (switch configuration template) in the organization.

## Gotchas

- Network templates define switch port profiles, VLANs, and RADIUS settings.
- Applied to sites to configure switches at scale.

## Related Endpoints

- [GET_orgs_org_id_networktemplates.md](GET_orgs_org_id_networktemplates.md) — List network templates
- [PUT_orgs_org_id_networktemplates_networktemplate_id.md](PUT_orgs_org_id_networktemplates_networktemplate_id.md) — Update
