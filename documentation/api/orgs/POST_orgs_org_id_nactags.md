...
`mistapi.api.v1.orgs.nac_tags.createOrgNacTag()`

## Usage Context

Creates a new NAC tag used for building NAC rules.

## Gotchas

- NAC tags categorize clients by attributes like RADIUS, certificate, or device type.

## Related Endpoints

- [GET_orgs_org_id_nactags.md](GET_orgs_org_id_nactags.md) — List NAC tags
