...
`mistapi.api.v1.orgs.clients_-_wireless.countOrgWirelessClientsSessions()`

## Usage Context

Returns the count of wireless client sessions grouped by specified fields.

## Gotchas

- Sessions represent individual client connections, not unique clients.

## Related Endpoints

- [GET_orgs_org_id_clients_sessions_search.md](GET_orgs_org_id_clients_sessions_search.md) — Search sessions
