...
`mistapi.api.v1.orgs.wxrules.listOrgWxRules()`

## Usage Context

Lists all WxLAN rules for the organization.

## Gotchas

- WxLAN rules use WxTags as source/destination identifiers.

## Related Endpoints

- [GET_orgs_org_id_wxrules_wxrule_id.md](GET_orgs_org_id_wxrules_wxrule_id.md) — Get specific rule
