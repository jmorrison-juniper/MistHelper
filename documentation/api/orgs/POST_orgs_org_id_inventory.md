...
`mistapi.api.v1.orgs.inventory.addOrgInventory()`

## Usage Context

Performs inventory management operations (assign, unassign, delete devices).

## Gotchas

- The `op` field determines the action: `assign`, `unassign`, or `delete`.
- Deleting removes the device from the org entirely.

## Related Endpoints

- [GET_orgs_org_id_inventory.md](GET_orgs_org_id_inventory.md) — List inventory
