...
`mistapi.api.v1.orgs.sdk_invites.listSdkInvites()`

## Usage Context

Lists all SDK invites for the organization.

## Gotchas

- SDK invites are for Mist mobile SDK integrations.

## Related Endpoints

- [GET_orgs_org_id_sdkinvites_sdkinvite_id.md](GET_orgs_org_id_sdkinvites_sdkinvite_id.md) — Get specific invite
