...
`mistapi.api.v1.orgs.wxtags.listOrgWxTags()`

## Usage Context

Lists all WxTags for the organization.

## Gotchas

- WxTags are building blocks for WxLAN rules.

## Related Endpoints

- [GET_orgs_org_id_wxtags_wxtag_id.md](GET_orgs_org_id_wxtags_wxtag_id.md) — Get specific tag
