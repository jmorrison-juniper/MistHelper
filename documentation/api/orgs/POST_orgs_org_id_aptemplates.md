...
`mistapi.api.v1.orgs.ap_templates.createOrgAptemplate()`

## Usage Context

Creates a new AP template for the organization.

## Gotchas

- AP templates define Wi-Fi and AP settings applied to sites.

## Related Endpoints

- [GET_orgs_org_id_aptemplates.md](GET_orgs_org_id_aptemplates.md) — List templates
- [PUT_orgs_org_id_aptemplates_aptemplate_id.md](PUT_orgs_org_id_aptemplates_aptemplate_id.md) — Update template
