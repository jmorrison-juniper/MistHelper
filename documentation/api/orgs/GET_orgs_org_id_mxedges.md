...
|------|------|----------|---------|------|-------------|
| for_site | string | No |  |  | Filter for org/site level mist edges |
...
`mistapi.api.v1.orgs.mxedges.listOrgMxEdges()`

## Usage Context

Lists all Mist Edge appliances for the organization.
...
- [GET_orgs_org_id_mxedges_mxedge_id.md](GET_orgs_org_id_mxedges_mxedge_id.md) — Get specific edge
- [POST_orgs_org_id_mxedges.md](POST_orgs_org_id_mxedges.md) — Create edge
