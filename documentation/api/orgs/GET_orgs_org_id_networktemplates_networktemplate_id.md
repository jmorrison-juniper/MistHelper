...
`mistapi.api.v1.orgs.network_templates.getOrgNetworkTemplate()`

## Usage Context

Retrieves a specific network template (switch template) by ID.

## Gotchas

- Network templates define switch port profiles, VLANs, and other switch settings.

## Related Endpoints

- [GET_orgs_org_id_networktemplates.md](GET_orgs_org_id_networktemplates.md) — List templates
- [PUT_orgs_org_id_networktemplates_networktemplate_id.md](PUT_orgs_org_id_networktemplates_networktemplate_id.md) — Update template

## MistHelper Notes

Used by MistHelper via `listOrgNetworkTemplates` in Menus 4, 35.
