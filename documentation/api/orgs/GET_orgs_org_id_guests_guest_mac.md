...
`mistapi.api.v1.orgs.guests.getOrgGuestAuthorization()`

## Usage Context

Retrieves guest authorization details for a specific MAC address.

## Gotchas

- Returns all authorizations across sites for this guest MAC.
