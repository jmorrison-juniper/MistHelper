...
`mistapi.api.v1.orgs.ap_templates.listOrgAptemplates()`

## Usage Context

Lists all AP templates for the organization.

## Gotchas

- AP templates define radio settings, IP configurations, and AP-specific overrides.

## Related Endpoints

- [GET_orgs_org_id_aptemplates_aptemplate_id.md](GET_orgs_org_id_aptemplates_aptemplate_id.md) — Get specific template
- [POST_orgs_org_id_aptemplates.md](POST_orgs_org_id_aptemplates.md) — Create template

## MistHelper Notes

Used by MistHelper via `listOrgApTemplates` in Menu 35 (List Org Templates).
