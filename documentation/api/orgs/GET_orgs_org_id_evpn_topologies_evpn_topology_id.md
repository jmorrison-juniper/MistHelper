...
`mistapi.api.v1.orgs.evpn_topologies.getOrgEvpnTopology()`

## Usage Context

Retrieves a specific EVPN topology by ID.

## Gotchas

- EVPN topologies define VxLAN/MP-BGP configurations for campus or data center fabrics.
