...
`mistapi.api.v1.orgs.asset_filters.createOrgAssetFilter()`

## Usage Context

Creates a new asset filter for the organization.

## Gotchas

- Asset filters define which BLE beacons are tracked.

## Related Endpoints

- [GET_orgs_org_id_assetfilters.md](GET_orgs_org_id_assetfilters.md) — List filters
- [PUT_orgs_org_id_assetfilters_assetfilter_id.md](PUT_orgs_org_id_assetfilters_assetfilter_id.md) — Update filter
