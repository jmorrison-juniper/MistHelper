...
`mistapi.api.v1.orgs.stats_-_ports.searchOrgSwOrGwPorts()`

## Usage Context

Searches for switch port statistics across the organization.

## Gotchas

- Can filter by port_id, full_duplex, speed, up, auth_state, etc.

## Related Endpoints

- [GET_orgs_org_id_stats_ports_count.md](GET_orgs_org_id_stats_ports_count.md) — Count ports
