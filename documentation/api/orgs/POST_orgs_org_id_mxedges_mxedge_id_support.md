...
`mistapi.api.v1.orgs.mxedges.uploadOrgMxEdgeSupportFiles()`

## Usage Context

Generates a support bundle from a Mist Edge appliance.

## Gotchas

- Support bundles contain logs and diagnostics for troubleshooting.
