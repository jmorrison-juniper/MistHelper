...
`mistapi.api.v1.orgs.wxrules.createOrgWxRule()`

## Usage Context

Creates a new WxLAN rule for WLAN access restrictions.

## Gotchas

- WxRules control traffic between WxTags (client groups and resource groups).
