...
`mistapi.api.v1.orgs.mxedges.getOrgMxEdge()`

## Usage Context

Retrieves details for a specific Mist Edge appliance.

## Gotchas

- Returns configuration, status, and tunnel information.

## Related Endpoints

- [GET_orgs_org_id_mxedges.md](GET_orgs_org_id_mxedges.md) — List edges
- [PUT_orgs_org_id_mxedges_mxedge_id.md](PUT_orgs_org_id_mxedges_mxedge_id.md) — Update edge
