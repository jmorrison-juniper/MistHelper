...
`mistapi.api.v1.orgs.devices_-_others.searchOrgOtherDeviceEvents()`

## Usage Context

Searches events for non-Juniper devices across the organization.
...
- [GET_orgs_org_id_otherdevices_events_count.md](GET_orgs_org_id_otherdevices_events_count.md) — Count events
