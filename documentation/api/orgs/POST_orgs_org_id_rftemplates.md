...
`mistapi.api.v1.orgs.rf_templates.createOrgRfTemplate()`

## Usage Context

Creates a new RF (Radio Frequency) template in the organization.

## Gotchas

- RF templates control radio power, channels, and band steering.
- Applied to sites to standardize radio behavior.

## Related Endpoints

- [GET_orgs_org_id_rftemplates.md](GET_orgs_org_id_rftemplates.md) — List RF templates
- [PUT_orgs_org_id_rftemplates_rftemplate_id.md](PUT_orgs_org_id_rftemplates_rftemplate_id.md) — Update

## MistHelper Notes

RF template listing uses Menu 37 (`listOrgRfTemplates`). Creation is not used directly.
