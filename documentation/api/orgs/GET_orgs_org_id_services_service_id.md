...
`mistapi.api.v1.orgs.services.getOrgService()`

## Usage Context

Retrieves a specific service definition by ID.

## Gotchas

- Services define application types used in service policies and security rules.

## Related Endpoints

- [GET_orgs_org_id_services.md](GET_orgs_org_id_services.md) — List services
- [PUT_orgs_org_id_services_service_id.md](PUT_orgs_org_id_services_service_id.md) — Update service
