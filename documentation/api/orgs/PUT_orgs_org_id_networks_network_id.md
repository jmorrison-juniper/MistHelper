...
`mistapi.api.v1.orgs.networks.updateOrgNetwork()`

## Usage Context

Updates an existing network (subnet/VLAN) definition.

## Gotchas

- Network changes may affect connected WLANs and switch templates.
