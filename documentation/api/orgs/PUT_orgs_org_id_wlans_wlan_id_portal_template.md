...
`mistapi.api.v1.orgs.wlans.updateOrgWlanPortalTemplate()`

## Usage Context

Updates the captive portal template for an org-level WLAN.

## Gotchas

- Portal templates define the captive portal look and feel.
