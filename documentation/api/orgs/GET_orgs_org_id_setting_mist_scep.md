...
`mistapi.api.v1.orgs.scep.getOrgMistScep()`

## Usage Context

Retrieves SCEP (Simple Certificate Enrollment Protocol) settings for the organization.

## Gotchas

- SCEP is typically configured alongside Mist NAC for certificate-based authentication.
