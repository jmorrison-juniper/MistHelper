...
`mistapi.api.v1.orgs.stats_-_mxedges.getOrgMxEdgeStats()`

## Usage Context

Retrieves statistics for a specific Mist Edge appliance.

## Gotchas

- Stats include CPU, memory, tunnel counts, and uptime.

## Related Endpoints

- [GET_orgs_org_id_stats_mxedges.md](GET_orgs_org_id_stats_mxedges.md) — List all Mist Edge stats
- [GET_orgs_org_id_mxedges_mxedge_id.md](GET_orgs_org_id_mxedges_mxedge_id.md) — Mist Edge config
