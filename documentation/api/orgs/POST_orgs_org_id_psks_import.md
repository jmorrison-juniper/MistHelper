...
`mistapi.api.v1.orgs.psks.importOrgPsks()`

## Usage Context

Bulk-imports PSKs into the organization from a CSV or JSON payload.

## Gotchas

- Existing PSKs with matching names may be overwritten depending on import settings.

## Related Endpoints

- [GET_orgs_org_id_psks.md](GET_orgs_org_id_psks.md) — List PSKs
- [POST_orgs_org_id_psks.md](POST_orgs_org_id_psks.md) — Create single PSK
