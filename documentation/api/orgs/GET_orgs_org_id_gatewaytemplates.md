...
`mistapi.api.v1.orgs.gateway_templates.listOrgGatewayTemplates()`

## Usage Context

Lists all gateway templates for the organization.

## Gotchas

- Templates can be for SRX, SSR, or both device types.

## Related Endpoints

- [GET_orgs_org_id_gatewaytemplates_gatewaytemplate_id.md](GET_orgs_org_id_gatewaytemplates_gatewaytemplate_id.md) — Get specific template
