...
Updates an existing VPN (WAN overlay) configuration.

## Gotchas

- VPN topology changes may cause brief WAN disruption.
...
VPN listing uses Menu 4 (`listOrgVpns`). Update is not used directly.
