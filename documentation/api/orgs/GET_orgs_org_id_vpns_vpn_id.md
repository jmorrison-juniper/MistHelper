...
`mistapi.api.v1.orgs.vpns.getOrgVpn()`

## Usage Context

Retrieves a specific VPN configuration by ID.

## Gotchas

- VPN configs define overlay hub-spoke or mesh topologies for WAN Assurance.
