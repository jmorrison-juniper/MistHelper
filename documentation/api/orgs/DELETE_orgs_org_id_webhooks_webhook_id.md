...
`mistapi.api.v1.orgs.webhooks.deleteOrgWebhook()`

## Usage Context

Deletes a webhook configuration from the organization.

## Gotchas

- Events will no longer be pushed to the deleted webhook URL.
