...
`PUT /api/v1/orgs/{org_id}/wxrules/{wxrule_id}`
...
`mistapi.api.v1.orgs.wxrules.updateOrgWxRule()`

## Usage Context

Updates an existing WxLAN rule.

## Gotchas

- WxRule changes affect traffic policy between client and resource groups.
