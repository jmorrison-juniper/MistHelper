...
`mistapi.api.v1.orgs.device_profiles.listOrgDeviceProfiles()`

## Usage Context

Lists all device profiles for the organization.

## Gotchas

- Use `type` parameter to filter by AP, switch, or gateway profiles.

## Related Endpoints

- [GET_orgs_org_id_deviceprofiles_deviceprofile_id.md](GET_orgs_org_id_deviceprofiles_deviceprofile_id.md) — Get specific profile
