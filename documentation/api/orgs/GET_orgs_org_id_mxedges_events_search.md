...
`mistapi.api.v1.orgs.mxedges.searchOrgMistEdgeEvents()`

## Usage Context

Searches Mist Edge events across the organization.
...
- [GET_orgs_org_id_mxedges_events_count.md](GET_orgs_org_id_mxedges_events_count.md) — Count events
