...
Retrieves a specific NAC portal configuration by ID.

## Gotchas

- Includes RADIUS settings, VLAN assignments, and authentication methods.

## Related Endpoints

- [GET_orgs_org_id_nacportals.md](GET_orgs_org_id_nacportals.md) — List portals
- [PUT_orgs_org_id_nacportals_nacportal_id.md](PUT_orgs_org_id_nacportals_nacportal_id.md) — Update portal
