...
`mistapi.api.v1.orgs.security_policies.listOrgSecPolicies()`

## Usage Context

Lists all security policies for the organization.

## Gotchas

- Policies are ordered; rule order matters for matching.

## Related Endpoints

- [GET_orgs_org_id_secpolicies_secpolicy_id.md](GET_orgs_org_id_secpolicies_secpolicy_id.md) — Get specific policy
