...
Retrieves the license summary for the organization.

## Gotchas

- Shows total, consumed, and remaining licenses per type.

## Related Endpoints

- [GET_orgs_org_id_licenses_usages.md](GET_orgs_org_id_licenses_usages.md) — Detailed usage
- [GET_orgs_org_id_inventory.md](GET_orgs_org_id_inventory.md) — Device inventory
