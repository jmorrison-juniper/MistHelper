...
`mistapi.api.v1.orgs.sso.downloadOrgSamlMetadata()`

## Usage Context

Retrieves SAML metadata in raw XML format for a specific SSO configuration.

## Gotchas

- This endpoint returns XML, not JSON. Parse accordingly.

## Related Endpoints

- [GET_orgs_org_id_ssos_sso_id_metadata.md](GET_orgs_org_id_ssos_sso_id_metadata.md) — JSON metadata
