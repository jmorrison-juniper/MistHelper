...
`mistapi.api.v1.orgs.psk_portals.createOrgPskPortal()`

## Usage Context

Creates a new PSK (Pre-Shared Key) portal for self-service PSK provisioning.

## Gotchas

- PSK portals enable users to create their own unique PSKs.
