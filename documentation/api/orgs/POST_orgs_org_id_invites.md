...
`mistapi.api.v1.orgs.admins.inviteOrgAdmin()`

## Usage Context

Sends an admin invite to join the organization.

## Gotchas

- Invites expire after a set period.
- The invited user must have a Mist account or create one.
