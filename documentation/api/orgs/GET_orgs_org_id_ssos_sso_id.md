...
`mistapi.api.v1.orgs.sso.getOrgSso()`

## Usage Context

Retrieves a specific SSO configuration by ID.

## Gotchas

- SSO configs contain IdP certificate, entity ID, and attribute mappings.

## Related Endpoints

- [GET_orgs_org_id_ssos.md](GET_orgs_org_id_ssos.md) — List SSOs
- [PUT_orgs_org_id_ssos_sso_id.md](PUT_orgs_org_id_ssos_sso_id.md) — Update SSO
- [GET_orgs_org_id_ssos_sso_id_failures.md](GET_orgs_org_id_ssos_sso_id_failures.md) — Login failures
