...
`mistapi.api.v1.orgs.security_policies.getOrgSecPolicy()`

## Usage Context

Retrieves a specific security policy by ID.

## Gotchas

- Security policies define firewall rules for WAN edge gateways.

## Related Endpoints

- [GET_orgs_org_id_secpolicies.md](GET_orgs_org_id_secpolicies.md) — List policies
- [PUT_orgs_org_id_secpolicies_secpolicy_id.md](PUT_orgs_org_id_secpolicies_secpolicy_id.md) — Update policy
