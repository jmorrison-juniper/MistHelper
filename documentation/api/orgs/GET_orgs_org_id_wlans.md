...
Lists all WLANs (wireless network/SSID configurations) for the organization.

## Gotchas

- Org-level WLANs are typically part of WLAN templates.
- PSK passphrases may be included in the response.

## Related Endpoints

- [GET_orgs_org_id_wlans_wlan_id.md](GET_orgs_org_id_wlans_wlan_id.md) — Get specific WLAN
- [POST_orgs_org_id_wlans.md](POST_orgs_org_id_wlans.md) — Create WLAN

## MistHelper Notes

Used by MistHelper via `listOrgWlans` in Menu 48, 102, and 122.
