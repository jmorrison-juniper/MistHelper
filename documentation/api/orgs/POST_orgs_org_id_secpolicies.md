...
`mistapi.api.v1.orgs.security_policies.createOrgSecPolicy()`

## Usage Context

Creates a new security policy for the organization.

## Gotchas

- Security policies define firewall rules for SRX gateways.

## Related Endpoints

- [GET_orgs_org_id_secpolicies.md](GET_orgs_org_id_secpolicies.md) — List policies
- [PUT_orgs_org_id_secpolicies_secpolicy_id.md](PUT_orgs_org_id_secpolicies_secpolicy_id.md) — Update
