...
`mistapi.api.v1.orgs.wlans.getOrgWLAN()`

## Usage Context

Retrieves a specific WLAN (wireless network/SSID) configuration by ID.

## Gotchas

- WLAN configs include auth type, VLAN, band steering, and security settings.

## Related Endpoints

- [GET_orgs_org_id_wlans.md](GET_orgs_org_id_wlans.md) — List WLANs
