...
> API Reference: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/orgs/licenses/create-org-async-claim
...
```python
createOrgAsyncClaim(mist_session: mistapi.__api_session.APISession, org_id: str, body: dict | list) -> mistapi.__api_response.APIResponse
```
