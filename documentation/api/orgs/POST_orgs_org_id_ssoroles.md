...
`mistapi.api.v1.orgs.sso_roles.createOrgSsoRole()`

## Usage Context

Creates a new SSO role mapping in the organization.

## Gotchas

- SSO roles map identity provider groups to Mist privilege levels.

## Related Endpoints

- [GET_orgs_org_id_ssoroles.md](GET_orgs_org_id_ssoroles.md) — List SSO roles
