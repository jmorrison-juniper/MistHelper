...
Searches guest authorizations across the organization.

## Gotchas

- Supports filtering by MAC, name, company, and authorization type.

## Related Endpoints

- [GET_orgs_org_id_guests_count.md](GET_orgs_org_id_guests_count.md) — Count guests
- [GET_orgs_org_id_guests.md](GET_orgs_org_id_guests.md) — List guests
