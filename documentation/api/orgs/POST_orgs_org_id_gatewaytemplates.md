...
`mistapi.api.v1.orgs.gateway_templates.createOrgGatewayTemplate()`

## Usage Context

Creates a new gateway template for the organization.

## Gotchas

- Gateway templates define WAN, LAN, and routing settings for SRX/SSR gateways.
