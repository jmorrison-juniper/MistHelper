...
|------|------|----------|---------|------|-------------|
| distinct | string | No |  |  | Distinct attributes to count |
...
`mistapi.api.v1.orgs.jsi.countOrgJsiAssetsAndContracts()`

## Usage Context

Returns the count of JSI inventory items grouped by specified fields.
