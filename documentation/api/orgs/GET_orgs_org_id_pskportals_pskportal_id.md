...
`mistapi.api.v1.orgs.psk_portals.getOrgPskPortal()`

## Usage Context

Retrieves a specific PSK portal by ID.

## Gotchas

- PSK portals allow self-service PSK creation for guests or employees.

## Related Endpoints

- [GET_orgs_org_id_pskportals.md](GET_orgs_org_id_pskportals.md) — List portals
- [PUT_orgs_org_id_pskportals_pskportal_id.md](PUT_orgs_org_id_pskportals_pskportal_id.md) — Update portal
