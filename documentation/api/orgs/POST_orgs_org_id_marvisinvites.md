...
`mistapi.api.v1.orgs.marvis_invites.createOrgMarvisClientInvite()`

## Usage Context

Creates a Marvis invite for the organization.

## Gotchas

- Marvis invites grant AI assistant access to specific users.

## Related Endpoints

- [GET_orgs_org_id_marvisinvites.md](GET_orgs_org_id_marvisinvites.md) — List invites
- [PUT_orgs_org_id_marvisinvites_marvisinvite_id.md](PUT_orgs_org_id_marvisinvites_marvisinvite_id.md) — Update invite
