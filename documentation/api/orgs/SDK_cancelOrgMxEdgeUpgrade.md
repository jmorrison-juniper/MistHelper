...
> API Reference: https://www.juniper.net/documentation/us/en/software/mist/api/http/api/utilities/upgrade/cancel-org-mx-edge-upgrade
...
```python
cancelOrgMxEdgeUpgrade(mist_session: mistapi.__api_session.APISession, org_id: str, upgrade_id: str) -> mistapi.__api_response.APIResponse
```
