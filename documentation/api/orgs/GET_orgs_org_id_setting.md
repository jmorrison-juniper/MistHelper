...
`mistapi.api.v1.orgs.setting.getOrgSettings()`

## Usage Context

Retrieves the full organization settings object.

## Gotchas

- Contains many nested objects (auto_device_naming, cacerts, celona, cloudshark, cradlepoint, device_cert, installer, jcloud, juniper, mgmt, mist_nac, mxedge_mgmt, pcap, security, switch_mgmt, synthetic_test, ui_idle_timeout, vpn_options, wan_pma, wired_pma, wireless_pma).
- Sensitive data like API keys may be present.
...
- [GET_orgs_org_id_setting_zscaler_setup.md](GET_orgs_org_id_setting_zscaler_setup.md) — Zscaler setup
