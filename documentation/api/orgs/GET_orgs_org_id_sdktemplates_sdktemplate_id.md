...
`mistapi.api.v1.orgs.sdk_templates.getSdkTemplate()`

## Usage Context

Retrieves a specific SDK template by ID.

## Gotchas

- SDK templates configure mobile SDK behavior.

## Related Endpoints

- [GET_orgs_org_id_sdktemplates.md](GET_orgs_org_id_sdktemplates.md) — List templates
- [PUT_orgs_org_id_sdktemplates_sdktemplate_id.md](PUT_orgs_org_id_sdktemplates_sdktemplate_id.md) — Update template
