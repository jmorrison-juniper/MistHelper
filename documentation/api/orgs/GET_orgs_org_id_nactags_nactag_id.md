...
`mistapi.api.v1.orgs.nac_tags.getOrgNacTag()`

## Usage Context

Retrieves a specific NAC tag by ID.

## Gotchas

- NAC tags are building blocks for NAC rules; they match on attributes like RADIUS, LDAP, or certificate fields.

## Related Endpoints

- [GET_orgs_org_id_nactags.md](GET_orgs_org_id_nactags.md) — List tags
- [PUT_orgs_org_id_nactags_nactag_id.md](PUT_orgs_org_id_nactags_nactag_id.md) — Update tag
