...
`mistapi.api.v1.orgs.tickets.getOrgTicket()`
...
- Includes ticket comments, status, and associated device/site info.

## Related Endpoints

- [GET_orgs_org_id_tickets.md](GET_orgs_org_id_tickets.md) — List tickets
- [GET_orgs_org_id_tickets_ticket_id_attachments_attachment_id.md](GET_orgs_org_id_tickets_ticket_id_attachments_attachment_id.md) — Get attachment
