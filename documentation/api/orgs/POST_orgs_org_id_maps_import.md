...
`mistapi.api.v1.orgs.maps.importOrgMaps()`

## Usage Context

Imports floor plan maps into the organization.

## Gotchas

- Supports various image formats (PNG, JPEG, PDF).
- Maps must be associated with a site.

## Related Endpoints

- [POST_orgs_org_id_sites_site_name_maps_import.md](POST_orgs_org_id_sites_site_name_maps_import.md) — Import to specific site
