...
`mistapi.api.v1.orgs.mxedges.countOrgSiteMxEdgeEvents()`

## Usage Context

Returns the count of Mist Edge events grouped by specified fields.
...
- [GET_orgs_org_id_mxedges_events_search.md](GET_orgs_org_id_mxedges_events_search.md) — Search events
