...
`mistapi.api.v1.orgs.webhooks.updateOrgWebhook()`
...
- Changing the URL requires re-verifying the endpoint.
...
Webhook listing uses Menu 47 (`listOrgWebhooks`). Update is not used directly.
