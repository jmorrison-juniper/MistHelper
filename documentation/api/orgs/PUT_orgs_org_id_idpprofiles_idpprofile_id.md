...
`mistapi.api.v1.orgs.idp_profiles.updateOrgIdpProfile()`

## Usage Context

Updates an existing IDP (Intrusion Detection and Prevention) profile.

## Gotchas

- IDP profiles define attack signatures and actions for SRX gateways.
