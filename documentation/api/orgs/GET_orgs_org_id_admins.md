...
`mistapi.api.v1.orgs.admins.listOrgAdmins()`

## Usage Context

Lists all administrators for the organization.

## Gotchas

- Returns admins with their privilege levels and scope.
...
Used by MistHelper via `listOrgAdmins` in Menu 55 (List Org Admins).
