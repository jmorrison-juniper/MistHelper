...
`mistapi.api.v1.orgs.sdk_invites.createSdkInvite()`

## Usage Context

Creates a new SDK invite for mobile SDK integration.

## Gotchas

- SDK invites enable mobile apps to use Mist SDK features like indoor location.
