...
`mistapi.api.v1.orgs.alarm_templates.updateOrgAlarmTemplate()`

## Usage Context

Updates an existing alarm template.

## Gotchas

- Changes affect all sites using this alarm template.
...
Alarm template listing uses Menu 50 (`listOrgAlarmTemplates`). Update is not used directly.
