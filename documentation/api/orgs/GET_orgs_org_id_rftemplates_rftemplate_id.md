...
`mistapi.api.v1.orgs.rf_templates.getOrgRfTemplate()`

## Usage Context

Retrieves a specific RF (Radio Frequency) template by ID.

## Gotchas

- RF templates define channel plans, power settings, and band steering.

## Related Endpoints

- [GET_orgs_org_id_rftemplates.md](GET_orgs_org_id_rftemplates.md) — List templates
- [PUT_orgs_org_id_rftemplates_rftemplate_id.md](PUT_orgs_org_id_rftemplates_rftemplate_id.md) — Update template
