...
`mistapi.api.v1.orgs.wxtunnels.createOrgWxTunnel()`

## Usage Context

Creates a new WxLAN tunnel configuration.

## Gotchas

- WxTunnels define traffic tunneling for WxLAN rules.

## Related Endpoints

- [GET_orgs_org_id_wxtunnels.md](GET_orgs_org_id_wxtunnels.md) — List WxTunnels
- [PUT_orgs_org_id_wxtunnels_wxtunnel_id.md](PUT_orgs_org_id_wxtunnels_wxtunnel_id.md) — Update
