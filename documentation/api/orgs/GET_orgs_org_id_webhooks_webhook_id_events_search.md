...
`mistapi.api.v1.orgs.webhooks.searchOrgWebhooksDeliveries()`

## Usage Context

Searches for events related to a specific webhook.

## Gotchas

- Shows delivery status, HTTP status codes, and error details.

## Related Endpoints

- [GET_orgs_org_id_webhooks_webhook_id_events_count.md](GET_orgs_org_id_webhooks_webhook_id_events_count.md) — Count events
