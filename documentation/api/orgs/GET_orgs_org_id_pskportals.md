...
`mistapi.api.v1.orgs.psk_portals.listOrgPskPortals()`

## Usage Context

Lists all PSK portals for the organization.
...
- [GET_orgs_org_id_pskportals_pskportal_id.md](GET_orgs_org_id_pskportals_pskportal_id.md) — Get specific portal
- [POST_orgs_org_id_pskportals.md](POST_orgs_org_id_pskportals.md) — Create portal
