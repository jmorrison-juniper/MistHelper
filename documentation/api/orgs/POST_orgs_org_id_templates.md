...
`mistapi.api.v1.orgs.wlan_templates.createOrgTemplate()`

## Usage Context

Creates a new configuration template in the organization.

## Gotchas

- Templates combine WLAN, network, and policy configurations.
- Applied to sites for consistent configuration.

## Related Endpoints

- [GET_orgs_org_id_templates.md](GET_orgs_org_id_templates.md) — List templates
- [POST_orgs_org_id_templates_template_id_clone.md](POST_orgs_org_id_templates_template_id_clone.md) — Clone

## MistHelper Notes

Template listing uses Menu 34 (`listOrgTemplates`). Creation is not used directly.
