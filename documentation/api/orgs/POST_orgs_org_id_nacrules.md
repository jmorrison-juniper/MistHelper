...
`mistapi.api.v1.orgs.nac_rules.createOrgNacRule()`

## Usage Context

Creates a new NAC rule for network access control.

## Gotchas

- NAC rules use NAC tags to match clients and assign policies.
- Rule order matters for evaluation priority.

## Related Endpoints

- [GET_orgs_org_id_nacrules.md](GET_orgs_org_id_nacrules.md) — List NAC rules
