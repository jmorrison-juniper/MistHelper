...
`mistapi.api.v1.orgs.service_policies.listOrgServicePolicies()`

## Usage Context

Lists all service policies for the organization.

## Gotchas

- Service policies are part of the WAN Assurance configuration stack.

## Related Endpoints

- [GET_orgs_org_id_servicepolicies_servicepolicy_id.md](GET_orgs_org_id_servicepolicies_servicepolicy_id.md) — Get specific policy
