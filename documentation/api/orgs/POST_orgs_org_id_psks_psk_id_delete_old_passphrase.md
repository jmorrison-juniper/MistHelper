...
`mistapi.api.v1.orgs.psks.deleteOrgPskOldPassphrase()`

## Usage Context

Deletes the old passphrase from a PSK after a passphrase rotation.

## Gotchas

- Only applicable during the transition window of a PSK rotation.
