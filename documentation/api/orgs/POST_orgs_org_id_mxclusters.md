...
`mistapi.api.v1.orgs.mxclusters.createOrgMxEdgeCluster()`

## Usage Context

Creates a new Mist Edge cluster for the organization.

## Gotchas

- Clusters provide HA and load balancing for Mist Edge appliances.

## Related Endpoints

- [GET_orgs_org_id_mxclusters.md](GET_orgs_org_id_mxclusters.md) — List clusters
- [PUT_orgs_org_id_mxclusters_mxcluster_id.md](PUT_orgs_org_id_mxclusters_mxcluster_id.md) — Update cluster
