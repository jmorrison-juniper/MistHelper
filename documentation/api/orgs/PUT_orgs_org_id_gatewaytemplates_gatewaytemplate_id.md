...
`mistapi.api.v1.orgs.gateway_templates.updateOrgGatewayTemplate()`

## Usage Context

Updates an existing gateway template.

## Gotchas

- Changes propagate to all gateways using this template.
...
Gateway template listing uses Menu 38 (`listOrgGatewayTemplates`). Update is not used directly.
