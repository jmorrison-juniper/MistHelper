...
`mistapi.api.v1.orgs.evpn_topologies.createOrgEvpnTopology()`

## Usage Context

Creates a new EVPN topology for the organization.

## Gotchas

- EVPN topologies define VxLAN/MP-BGP fabric configurations.
- Requires compatible EX switch hardware.

## Related Endpoints

- [GET_orgs_org_id_evpn_topologies.md](GET_orgs_org_id_evpn_topologies.md) — List topologies
- [PUT_orgs_org_id_evpn_topologies_evpn_topology_id.md](PUT_orgs_org_id_evpn_topologies_evpn_topology_id.md) — Update topology
