...
Lists all PSKs (Pre-Shared Keys) for the organization.

## Gotchas

- Can return a large number of PSKs; use pagination.
- PSK passphrases are included in the response.

## Related Endpoints

- [GET_orgs_org_id_psks_psk_id.md](GET_orgs_org_id_psks_psk_id.md) — Get specific PSK
