...
`mistapi.api.v1.orgs.stats_-_bgp_peers.searchOrgBgpStats()`

## Usage Context

Searches for BGP peer statistics across the organization.

## Gotchas

- Can filter by state (established, idle, active, etc.).

## Related Endpoints

- [GET_orgs_org_id_stats_bgp_peers_count.md](GET_orgs_org_id_stats_bgp_peers_count.md) — Count BGP peers
