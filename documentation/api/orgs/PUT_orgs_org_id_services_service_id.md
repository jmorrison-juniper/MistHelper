...
`mistapi.api.v1.orgs.services.updateOrgService()`

## Usage Context

Updates an existing service (application definition).

## Gotchas

- Changes affect all service policies referencing this service.
...
Service listing uses Menu 4 (`listOrgServices`). Update is not used directly.
