...
`mistapi.api.v1.orgs.stats_-_ports.countOrgSwOrGwPorts()`

## Usage Context

Returns the count of switch port statistics matching the specified filters.

## Gotchas

- Port stats are for EX series switches managed by Mist.

## Related Endpoints

- [GET_orgs_org_id_stats_ports_search.md](GET_orgs_org_id_stats_ports_search.md) — Search port stats
