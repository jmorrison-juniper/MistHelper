...
`mistapi.api.v1.orgs.stats_-_assets.listOrgAssetsStats()`

## Usage Context

Retrieves asset statistics for the organization.

## Gotchas

- Asset stats include location data from BLE beacons.

## Related Endpoints

- [GET_orgs_org_id_stats_assets_search.md](GET_orgs_org_id_stats_assets_search.md) — Search assets
- [GET_orgs_org_id_stats_assets_count.md](GET_orgs_org_id_stats_assets_count.md) — Count assets
- [GET_orgs_org_id_assets.md](GET_orgs_org_id_assets.md) — Asset config
