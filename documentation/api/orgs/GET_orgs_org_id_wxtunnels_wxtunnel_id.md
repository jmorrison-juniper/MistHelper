...
`mistapi.api.v1.orgs.wxtunnels.getOrgWxTunnel()`

## Usage Context

Retrieves a specific WxLAN tunnel by ID.

## Gotchas

- WxTunnels define VLAN tunneling between APs and remote endpoints.

## Related Endpoints

- [GET_orgs_org_id_wxtunnels.md](GET_orgs_org_id_wxtunnels.md) — List WxTunnels
- [PUT_orgs_org_id_wxtunnels_wxtunnel_id.md](PUT_orgs_org_id_wxtunnels_wxtunnel_id.md) — Update WxTunnel
