...
`mistapi.api.v1.orgs.wxtags.getOrgWxTag()`

## Usage Context

Retrieves a specific WxTag by ID.

## Gotchas

- WxTags can match by MAC, RADIUS attributes, hostname, or application.

## Related Endpoints

- [GET_orgs_org_id_wxtags.md](GET_orgs_org_id_wxtags.md) — List WxTags
- [PUT_orgs_org_id_wxtags_wxtag_id.md](PUT_orgs_org_id_wxtags_wxtag_id.md) — Update WxTag
