...
`mistapi.api.v1.orgs.devices.countOrgDeviceLastConfigs()`

## Usage Context

Returns the count of last device configurations grouped by specified fields.

## Gotchas

- Useful for auditing configuration changes across the fleet.

## Related Endpoints

- [GET_orgs_org_id_devices_last_config_search.md](GET_orgs_org_id_devices_last_config_search.md) — Search configs
