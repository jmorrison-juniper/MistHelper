...
| vlan | integer | No |  |  | Vlan name or ID assigned to the client |
...
| resp_attrs | array | No |  |  | Radius attributes returned by NAC to NAS derive |
| ssid | string | No |  |  | SSID |
...
`mistapi.api.v1.orgs.clients_-_nac.searchOrgNacClientEvents()`

## Usage Context

Searches NAC client events across the organization.
...
- [GET_orgs_org_id_nac_clients_events_count.md](GET_orgs_org_id_nac_clients_events_count.md) — Count events
- [GET_orgs_org_id_nac_clients_search.md](GET_orgs_org_id_nac_clients_search.md) — Search clients
