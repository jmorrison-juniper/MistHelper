...
`GET /api/v1/orgs/{org_id}/aamwprofiles`
...
`mistapi.api.v1.orgs.advanced_anti_malware_profiles.listOrgAAMWProfiles()`

## Usage Context

Lists all Advanced Anti-Malware (AAMW) profiles for the organization.
...
- [GET_orgs_org_id_aamwprofiles_aamwprofile_id.md](GET_orgs_org_id_aamwprofiles_aamwprofile_id.md) — Get specific profile
