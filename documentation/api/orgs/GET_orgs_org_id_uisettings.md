...
`mistapi.api.v1.orgs.ui_settings.listOrgUiSettings()`

## Usage Context

Lists all UI settings for the organization.

## Gotchas

- UI settings are primarily used by the Mist dashboard frontend.

## Related Endpoints

- [GET_orgs_org_id_uisettings_uisetting_id.md](GET_orgs_org_id_uisettings_uisetting_id.md) — Get specific setting
- [POST_orgs_org_id_uisettings.md](POST_orgs_org_id_uisettings.md) — Create UI settings
