...
`mistapi.api.v1.orgs.service_policies.getOrgServicePolicy()`

## Usage Context

Retrieves a specific service policy by ID.

## Gotchas

- Service policies map traffic to WAN paths and define application steering.

## Related Endpoints

- [GET_orgs_org_id_servicepolicies.md](GET_orgs_org_id_servicepolicies.md) — List service policies
- [PUT_orgs_org_id_servicepolicies_servicepolicy_id.md](PUT_orgs_org_id_servicepolicies_servicepolicy_id.md) — Update policy

## MistHelper Notes

Used by MistHelper via `listOrgServicePolicies` in Menu 4.
