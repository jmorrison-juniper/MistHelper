...
|------|------|----------|---------|------|-------------|
| for_site | string | No |  |  | Filter for site level mist edges |
...
`mistapi.api.v1.orgs.stats_-_mxedges.listOrgMxEdgesStats()`

## Usage Context

Retrieves statistics for all Mist Edge appliances in the organization.
...
- [GET_orgs_org_id_stats_mxedges_mxedge_id.md](GET_orgs_org_id_stats_mxedges_mxedge_id.md) — Specific Mist Edge stats
- [GET_orgs_org_id_mxedges.md](GET_orgs_org_id_mxedges.md) — Mist Edge config
