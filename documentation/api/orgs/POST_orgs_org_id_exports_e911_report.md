...
`POST /api/v1/orgs/{org_id}/exports/e911_report`
...
`mistapi.api.v1.orgs.exports.enableOrgE911Report()`
...
- Use it when you need to enable automatic E911 AP BSSID report generation for the organization.
...
- The installed `mistapi` 0.64.0 signature is `enableOrgE911Report(mist_session: mistapi.__api_session.APISession, org_id: str) -> mistapi.__api_response.APIResponse`.
...
MistHelper does not currently call `enableOrgE911Report`.
Verification source: `git grep -n "enableOrgE911Report" -- src MistHelper.py`.
