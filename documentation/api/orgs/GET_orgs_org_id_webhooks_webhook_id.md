...
`mistapi.api.v1.orgs.webhooks.getOrgWebhook()`
...
- Webhook secrets are included in the response for HMAC verification.

## Related Endpoints

- [GET_orgs_org_id_webhooks.md](GET_orgs_org_id_webhooks.md) — List webhooks
- [PUT_orgs_org_id_webhooks_webhook_id.md](PUT_orgs_org_id_webhooks_webhook_id.md) — Update webhook
