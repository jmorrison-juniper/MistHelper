...
`mistapi.api.v1.orgs.site_templates.deleteOrgSiteTemplate()`

## Usage Context

Deletes a site template from the organization.

## Gotchas

- Sites created from this template retain their settings but lose the template link.
