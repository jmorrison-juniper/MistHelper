...
`mistapi.api.v1.orgs.clients_-_wan.searchOrgWanClientEvents()`

## Usage Context

Searches for WAN client events across the organization.

## Gotchas

- Events include session start/stop, policy changes, and traffic anomalies.

## Related Endpoints

- [GET_orgs_org_id_wan_client_events_count.md](GET_orgs_org_id_wan_client_events_count.md) — Count events
