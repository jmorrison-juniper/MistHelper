...
`mistapi.api.v1.orgs.ui_settings.updateOrgUiSetting()`

## Usage Context

Updates or creates a specific UI setting entry.

## Gotchas

- UI settings are scoped per admin and stored as key-value pairs.
