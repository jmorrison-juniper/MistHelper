...
`mistapi.api.v1.orgs.integration_skyatp.udpateOrgAtpBlockedList()`

## Usage Context

Updates the Sky ATP SecIntel blocklist (blocked domains/IPs).

## Gotchas

- Blocklisted entries are immediately blocked at the SRX gateway.
