...
`mistapi.api.v1.orgs.sites.createOrgSite()`
...
- Sites require a name and ideally an address for timezone and country code.
- Site IDs are used extensively throughout the API.
...
Site creation is used in multiple Menu operations (11, 20, 27) via `createOrgSite`. Site listing is one of the most frequently used operations.
