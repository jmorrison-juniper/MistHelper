...
`mistapi.api.v1.orgs.sso.listOrgSsos()`

## Usage Context

Lists all SSO (Single Sign-On) configurations for the organization.

## Gotchas

- Supports SAML and OAuth-based SSO configurations.

## Related Endpoints

- [GET_orgs_org_id_ssos_sso_id.md](GET_orgs_org_id_ssos_sso_id.md) — Get specific SSO
