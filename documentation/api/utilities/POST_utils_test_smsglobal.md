...
`mistapi.api.v1.utilities.wi-fi.testSiteWlanSmsGlobal()`

## Usage Context

Tests SMSGlobal SMS gateway integration. Sends a test SMS message to verify the WLAN guest portal SMS configuration before going live.

## Gotchas

- Requires valid SMSGlobal API credentials configured in the WLAN settings.
- Test messages consume SMS credits.

## Related Endpoints

- [POST_utils_test_telstra.md](POST_utils_test_telstra.md) — Test Telstra SMS gateway
- [POST_utils_test_twilio.md](POST_utils_test_twilio.md) — Test Twilio SMS gateway
