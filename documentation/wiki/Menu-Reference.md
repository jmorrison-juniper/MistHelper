...
>>>>>>> 1d83065b (feat: add organization inventory search menu)
...
| 253 | Search organization inventory with optional filters (searchOrgInventory) | Interactive safe | `OrgInventorySearchExporter.inventory` |
